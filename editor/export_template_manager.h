...
class ExportTemplateManager : public AcceptDialog {
    ...
    void _download_template_completed(
        int p_status,
        int p_code,
    ...
    void _refresh_mirrors_completed(
        int p_status,
        int p_code,
        const PoolStringArray& headers,
        const PoolByteArray& p_data
    ...
    void _set_current_progress_status(
    ...
    void _install_file();
    bool _install_file_selected(
        const String& p_file,
        bool p_skip_progress = false
    );
