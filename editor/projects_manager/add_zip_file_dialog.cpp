...
AddZipFileDialog::AddZipFileDialog() {
...
void AddZipFileDialog::show_dialog(
...
void AddZipFileDialog::_bind_methods() {
    ClassDB::bind_method(
        "_on_browse_button_pressed",
        &AddZipFileDialog::_on_browse_button_pressed
    );
    ClassDB::bind_method(
        "_on_create_folder_button_pressed",
        &AddZipFileDialog::_on_create_folder_button_pressed
    );
    ClassDB::bind_method(
        "_on_project_folder_text_changed",
        &AddZipFileDialog::_on_project_folder_text_changed
    );
    ClassDB::bind_method(
...
void AddZipFileDialog::ok_pressed() {
    String zip_file_name  = zip_file_path.get_file();
...
void AddZipFileDialog::_on_create_folder_button_pressed() {
...
void AddZipFileDialog::_on_project_folder_selected(const String& p_folder) {
...
void AddZipFileDialog::_on_project_folder_text_changed(const String& p_text) {
...
void AddZipFileDialog::_remove_created_folder() {
...
void AddZipFileDialog::_set_error_message(const String& p_error_message) {
...
void AddZipFileDialog::_test_project_folder() {
    String project_folder = project_folder_line_edit->get_text().strip_edges();
