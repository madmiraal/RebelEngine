...
#ifndef ADD_ZIP_FILE_DIALOG_H
#define ADD_ZIP_FILE_DIALOG_H
...
class AddZipFileDialog : public ConfirmationDialog {
    GDCLASS(AddZipFileDialog, ConfirmationDialog);
