...
public:
    ...
    typedef Error (*EditorExportSaveSharedObject)(
        void* p_userdata,
...
private:
    ...
    void _edit_files_with_filter(
        DirAccess* da,
        const Vector<String>& p_filters,
        Set<String>& r_list,
        bool exclude
    );
    void _edit_filter_list(
        Set<String>& r_list,
...
protected:
    ...
    FeatureContainers get_feature_containers(
        const Ref<EditorExportPreset>& p_preset
    );

    bool exists_export_template(String template_file_name, String* err) const;
    String find_export_template(
...
public:
    ...
    Error export_project_files(
        ...
        void* p_udata,
        EditorExportSaveSharedObject p_so_func = nullptr
    );
    ...
    String test_etc2(
    ) const; // generic test for etc2 since most platforms use it
    ...
    virtual Error export_pack(
        const Ref<EditorExportPreset>& p_preset,
        bool p_debug,
        const String& p_path,
        int p_flags = 0
    );
    virtual Error export_zip(
        const Ref<EditorExportPreset>& p_preset,
        bool p_debug,
        const String& p_path,
        int p_flags = 0
...
public:
    ...
    void set_extension(
        ...
        const String& p_feature_key = "default"
    );
    void set_name(const String& p_name);
    ...
    void set_fixup_embedded_pck_func(
