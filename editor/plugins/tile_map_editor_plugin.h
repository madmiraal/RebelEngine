...
class TileMapEditor : public VBoxContainer {
    ...
    void _fill_points(
        const PoolVector<Vector2>& p_points,
        const Dictionary& p_op
    );
    ...
    void _draw_cell(
        Control* p_viewport,
        int p_cell,
        const Point2i& p_point,
        bool p_flip_h,
        bool p_flip_v,
        bool p_transpose,
        const Point2i& p_autotile_coord,
        const Transform2D& p_xform
    );
    void _draw_fill_preview(
        Control* p_viewport,
        int p_cell,
        const Point2i& p_point,
        bool p_flip_h,
    ...
    Dictionary _create_cell_dictionary(
        int tile,
        bool flip_x,
        bool flip_y,
        bool transpose,
    ...
    void _finish_undo();
    void _create_set_cell_undo_redo(
        const Vector2& p_vec,
        const CellOp& p_cell_old,
        const CellOp& p_cell_new
    );
    void _set_cell(
        const Point2i& p_pos,
        Vector<int> p_values,
