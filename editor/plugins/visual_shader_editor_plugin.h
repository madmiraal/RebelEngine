...
class VisualShaderEditor : public VBoxContainer {
    ...
    struct AddOption {
        ...
        AddOption(
            ...
            const String& p_category     = String(),
            const String& p_sub_category = String(),
        ...
        AddOption(
            ...
            const String& p_sub_category,
            const String& p_type,
            const String& p_description,
            const String& p_sub_func,
            int p_return_type = -1,
            int p_mode        = -1,
            int p_func        = -1,
            float p_value     = -1,
    ...
    void _uniform_select_item(
        Ref<VisualShaderNodeUniformRef> p_uniform,
        String p_name
    );

    void _add_input_port(
        int p_node,
        int p_port,
        int p_port_type,
        const String& p_name
