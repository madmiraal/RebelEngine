...
class ThemeItemEditorDialog : public AcceptDialog {
    ...
    void _add_theme_item(
        Theme::DataType p_data_type,
        String p_item_name,
        String p_item_type
    );
    void _remove_data_type_items(
        Theme::DataType p_data_type,
        String p_item_type
    );
...
class ThemeTypeEditor : public MarginContainer {
    ...
    OrderedHashMap<StringName, bool> _get_type_items(
        String p_type_name,
    ...
    void _item_rename_cbk(
        int p_data_type,
        String p_item_name,
        Control* p_control
    );
    void _item_rename_confirmed(
        int p_data_type,
        String p_item_name,
        Control* p_control
    );
    void _item_rename_entered(
        String p_value,
        int p_data_type,
        String p_item_name,
        Control* p_control
    );
    void _item_rename_canceled(
        int p_data_type,
        String p_item_name,
        Control* p_control
    );
