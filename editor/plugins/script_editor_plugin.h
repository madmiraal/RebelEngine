...
class ScriptEditor : public PanelContainer {
    ...
    static CreateSyntaxHighlighterFunc
        syntax_highlighters_funcs[SYNTAX_HIGHLIGHTER_FUNC_MAX];
    ...
    void _update_modified_scripts_for_external_editor(
        Ref<Script> p_for_script = Ref<Script>()
    );
    ...
    void _on_find_in_files_result_selected(
        String fpath,
        int line_number,
        int begin,
        int end
...
public:
    ...
    static void register_create_syntax_highlighter_function(
        CreateSyntaxHighlighterFunc p_func
    );
    static void register_create_script_editor_function(
