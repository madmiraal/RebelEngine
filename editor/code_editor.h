...
typedef void (*CodeTextEditorCodeCompleteFunc)(
    void* p_ud,
    const String& p_code,
...
protected:
    ...
    void _notification(int) override;
    static void _bind_methods();
...
public:
    ...
    /// Toggle inline comment on currently selected lines, or on current line if
    /// nothing is selected, by adding or removing comment delimiter
