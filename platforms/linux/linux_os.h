...
class LinuxOS : public UnixOS {
    ...
    int cursor_size;
    Map<CursorShape, const char*> xcursor_names;
    Map<CursorShape, XcursorImage*> cursor_images;
    Map<CursorShape, Cursor> cursors;
    Cursor null_cursor;
...
public:
    ...
    virtual void set_cursor_shape(CursorShape cursor_shape);
