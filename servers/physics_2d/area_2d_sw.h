...
class Area2DSW : public CollisionObject2DSW {
    ...
    SelfList<Area2DSW> monitor_query_list{this};
    SelfList<Area2DSW> moved_list{this};
...
public:
    //_FORCE_INLINE_ const Matrix32& get_inverse_transform() const { return
    ...
    Physics2DServer::AreaSpaceOverrideMode get_space_override_mode() const {
...
void Area2DSW::add_body_to_query(
    Body2DSW* p_body,
    uint32_t p_body_shape,
    uint32_t p_area_shape
) {
...
void Area2DSW::remove_body_from_query(
    Body2DSW* p_body,
    uint32_t p_body_shape,
    uint32_t p_area_shape
) {
...
void Area2DSW::add_area_to_query(
    Area2DSW* p_area,
    uint32_t p_area_shape,
    uint32_t p_self_shape
) {
...
void Area2DSW::remove_area_from_query(
    Area2DSW* p_area,
    uint32_t p_area_shape,
    uint32_t p_self_shape
) {
