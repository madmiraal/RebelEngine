...
SHAPE_CONCAVE_POLYGON, ///< Vector2 array:"triangles" , or Dictionary with
"indices" (int array) and "triangles" (Vector2 array) SHAPE_CUSTOM, ///<
...
public:
    ...
    ~ShapeOwner2DSW() override = default;
};
...
public:
    ...
    virtual void project_range_castv(
        const Vector2& p_cast,
        const Vector2& p_normal,
        const Transform2D& p_transform,
        real_t& r_min,
        real_t& r_max
    ...
    _FORCE_INLINE_ void get_supports_transformed_cast(
        const Vector2& p_cast,
        const Vector2& p_normal,
        ...
        get_supports(
            p_xform.basis_xform_inv(p_normal).normalized(),
            r_supports,
            r_amount
        );
...
#define DEFAULT_PROJECT_RANGE_CAST                                             \
    ...
    _FORCE_INLINE_ void project_range_cast(                                    \
        const Vector2& p_cast,                                                 \
        const Vector2& p_normal,                                               \
        const Transform2D& p_transform,                                        \
        real_t& r_min,                                                         \
...
public:
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_LINE;
    }
    ...
    bool contains_point(const Vector2& p_point) const override;
    ...
    real_t get_moment_of_inertia(real_t p_mass, const Size2& p_scale)
        const override;
...
public:
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_RAY;
    }
...
public:
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_SEGMENT;
    }

    _FORCE_INLINE_ Vector2 get_xformed_normal(const Transform2D& p_xform
    ) const {
...
public:
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_CIRCLE;
    }
...
public:
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_RECTANGLE;
    }
    ...
    _FORCE_INLINE_ Vector2 get_circle_axis(
        const Transform2D& p_xform,
        const Transform2D& p_xform_inv,
        const Vector2& p_circle
    ) const {
    ...
    _FORCE_INLINE_ Vector2 get_box_axis(
        const Transform2D& p_xform,
        const Transform2D& p_xform_inv,
        const RectangleShape2DSW* p_B,
        const Transform2D& p_B_xform,
        const Transform2D& p_B_xform_inv
    ) const {
        Vector2 a, b;
...
public:
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_CAPSULE;
    }
...
public:
    ...
    get_xformed_segment_normal(const Transform2D& p_xform, int p_idx) const {
    ...
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_CONVEX_POLYGON;
    }
    ...
    ~ConvexPolygonShape2DSW() override;
};
...
class ConcavePolygonShape2DSW : public ConcaveShape2DSW {
    ...
    struct BVH_CompareX {
        _FORCE_INLINE_ bool operator()(const BVH& a, const BVH& b) const {
            return (a.aabb.position.x + a.aabb.size.x * 0.5)
                 < (b.aabb.position.x + b.aabb.size.x * 0.5);
        }
    };

    struct BVH_CompareY {
        _FORCE_INLINE_ bool operator()(const BVH& a, const BVH& b) const {
            return (a.aabb.position.y + a.aabb.size.y * 0.5)
                 < (b.aabb.position.y + b.aabb.size.y * 0.5);
        }
    };
...
public:
    Physics2DServer::ShapeType get_type() const override {
        return Physics2DServer::SHAPE_CONCAVE_POLYGON;
    }
    ...
    void project_rangev(
        ...
        real_t& r_min,
        real_t& r_max
    ) const override { /*project_range(p_normal,p_transform,r_min,r_max);*/ }
