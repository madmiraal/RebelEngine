...
protected:
    ...
    Vector3 m_AnchorPos; // point between pivots of bodies A and B to solve
                         // linear axes
...
public:
    ...
    //! performs Jacobian calculation, and also calculates angle differences and
    //! axis
    ...
    */
    ...
    corrected. \pre Generic6DOFJointSW.buildJacobian must be called previously.
    */
