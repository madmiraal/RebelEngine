...
public:
    ...
    virtual Vector3 get_inverse_inertia(
    ) const = 0; // get density of this body space
    virtual Basis get_inverse_inertia_tensor(
    ) const = 0; // get density of this body space
...
private:
    Dictionary _intersect_ray(
        ...
        const Vector3& p_to,
        const Vector<RID>& p_exclude = Vector<RID>(),
        uint32_t p_collision_mask    = 0,
...
public:
    ...
    enum ShapeType {
        ...
        SHAPE_CONCAVE_POLYGON, ///< vector3 array:"triangles" , or Dictionary
                               ///< with "indices" (int array) and "triangles"
                               ///< (Vector3 array)
        SHAPE_HEIGHTMAP, ///< dict( int:"width", int:"depth",float:"cell_size",
                         ///< float_array:"heights"
        SHAPE_CUSTOM,    ///< Server-Implementation based custom shape, calling
                         ///< shape_create() with this value will result in an
                         ///< error
    };
    ...
    virtual void space_set_param(
        RID p_space,
        SpaceParameter p_param,
        real_t p_value
    ) = 0;
    virtual real_t space_get_param(RID p_space, SpaceParameter p_param)
        const = 0;
    ...
    virtual void area_set_space_override_mode(
        RID p_area,
        AreaSpaceOverrideMode p_mode
    )       = 0;
    virtual AreaSpaceOverrideMode area_get_space_override_mode(RID p_area
    ) const = 0;

    virtual void area_add_shape(
        RID p_area,
        RID p_shape,
    ...
    virtual Transform area_get_shape_transform(RID p_area, int p_shape_idx)
        const = 0;

    virtual void area_remove_shape(RID p_area, int p_shape_idx) = 0;
    virtual void area_clear_shapes(RID p_area)                  = 0;

    virtual void area_set_shape_disabled(
        RID p_area,
        int p_shape_idx,
        bool p_disabled
    ) = 0;
    ...
    virtual void area_set_transform(
        RID p_area,
        const Transform& p_transform
    ) = 0;

    virtual Variant area_get_param(RID p_parea, AreaParameter p_param)
        const                                              = 0;
    ...
    virtual void area_set_monitor_callback(
        RID p_area,
        Object* p_receiver,
        const StringName& p_method
    ) = 0;
    virtual void area_set_area_monitor_callback(
        RID p_area,
        Object* p_receiver,
        const StringName& p_method
    ) = 0;
    ...
    virtual Transform body_get_shape_transform(RID p_body, int p_shape_idx)
        const = 0;

    virtual void body_remove_shape(RID p_body, int p_shape_idx) = 0;
    virtual void body_clear_shapes(RID p_body)                  = 0;

    virtual void body_set_shape_disabled(
        RID p_body,
        int p_shape_idx,
        bool p_disabled
    ) = 0;
    ...
    virtual void body_set_enable_continuous_collision_detection(
        RID p_body,
        bool p_enable
    )       = 0;
    virtual bool body_is_continuous_collision_detection_enabled(RID p_body
    ) const = 0;
    ...
    virtual void body_set_kinematic_safe_margin(
        RID p_body,
        real_t p_margin
    )                                                               = 0;
    ...
    virtual void body_set_applied_torque(
        RID p_body,
    ...
    virtual void body_apply_central_impulse(
        RID p_body,
    ...
    virtual void body_apply_torque_impulse(
        RID p_body,
        const Vector3& p_impulse
    ) = 0;
    ...
    virtual void body_set_axis_lock(
        RID p_body,
        BodyAxis p_axis,
        bool p_lock
    )                                                                   = 0;
    ...
    virtual void body_get_collision_exceptions(
        RID p_body,
    ...
    // missing remove
    virtual void body_set_contacts_reported_depth_threshold(
        RID p_body,
        float p_threshold
    )       = 0;
    virtual float body_get_contacts_reported_depth_threshold(RID p_body
    ) const = 0;
    ...
    virtual void soft_body_update_visual_server(
        RID p_body,
        class SoftBodyVisualServerHandler* p_visual_server_handler
    ) = 0;
    ...
    virtual void soft_body_set_collision_layer(
        RID p_body,
        uint32_t p_layer
    )                                                                = 0;
    ...
    virtual void soft_body_add_collision_exception(
        RID p_body,
        RID p_body_b
    ) = 0;
    virtual void soft_body_remove_collision_exception(
        RID p_body,
        RID p_body_b
    ) = 0;
    virtual void soft_body_get_collision_exceptions(
        RID p_body,
        List<RID>* p_exceptions
    ) = 0;
    ...
    virtual Variant soft_body_get_state(RID p_body, BodyState p_state)
        const = 0;

    virtual void soft_body_set_transform(
        RID p_body,
        const Transform& p_transform
    ) = 0;
    virtual Vector3 soft_body_get_vertex_position(RID p_body, int vertex_index)
        const = 0;
    ...
    virtual void soft_body_set_simulation_precision(
        RID p_body,
        int p_simulation_precision
    )                                                          = 0;
    ...
    virtual void soft_body_set_linear_stiffness(
        RID p_body,
        real_t p_stiffness
    )                                                         = 0;
    ...
    virtual void soft_body_set_volume_stiffness(
        RID p_body,
        real_t p_stiffness
    )                                                         = 0;
    virtual real_t soft_body_get_volume_stiffness(RID p_body) = 0;

    virtual void soft_body_set_pressure_coefficient(
        RID p_body,
        real_t p_pressure_coefficient
    )                                                             = 0;
    virtual real_t soft_body_get_pressure_coefficient(RID p_body) = 0;

    virtual void soft_body_set_pose_matching_coefficient(
        RID p_body,
        real_t p_pose_matching_coefficient
    )                                                                  = 0;
    virtual real_t soft_body_get_pose_matching_coefficient(RID p_body) = 0;

    virtual void soft_body_set_damping_coefficient(
        RID p_body,
        real_t p_damping_coefficient
    )                                                            = 0;
    virtual real_t soft_body_get_damping_coefficient(RID p_body) = 0;

    virtual void soft_body_set_drag_coefficient(
        RID p_body,
        real_t p_drag_coefficient
    )                                                         = 0;
    virtual real_t soft_body_get_drag_coefficient(RID p_body) = 0;

    virtual void soft_body_move_point(
        RID p_body,
        int p_point_index,
        const Vector3& p_global_position
    ) = 0;
    virtual Vector3 soft_body_get_point_global_position(
        RID p_body,
        int p_point_index
    ) = 0;

    virtual Vector3 soft_body_get_point_offset(RID p_body, int p_point_index)
        const = 0;

    virtual void soft_body_remove_all_pinned_points(RID p_body) = 0;
    virtual void soft_body_pin_point(
        RID p_body,
        int p_point_index,
        bool p_pin
    )                                                                     = 0;
    ...
    virtual void joint_disable_collisions_between_bodies(
        RID p_joint,
        const bool p_disable
    )       = 0;
    virtual bool joint_is_disabled_collisions_between_bodies(RID p_joint
    ) const = 0;

    virtual RID joint_create_pin(
        RID p_body_A,
    ...
    virtual void pin_joint_set_param(
        RID p_joint,
        PinJointParam p_param,
        float p_value
    ) = 0;
    virtual float pin_joint_get_param(RID p_joint, PinJointParam p_param)
        const = 0;
    ...
    virtual RID joint_create_hinge(
        RID p_body_A,
        const Transform& p_hinge_A,
        RID p_body_B,
        const Transform& p_hinge_B
    ) = 0;
    virtual RID joint_create_hinge_simple(
        RID p_body_A,
    ...
    virtual void hinge_joint_set_param(
        RID p_joint,
        HingeJointParam p_param,
        float p_value
    ) = 0;
    virtual float hinge_joint_get_param(RID p_joint, HingeJointParam p_param)
        const = 0;

    virtual void hinge_joint_set_flag(
        RID p_joint,
        HingeJointFlag p_flag,
        bool p_value
    ) = 0;
    virtual bool hinge_joint_get_flag(RID p_joint, HingeJointFlag p_flag)
        const = 0;
    ...
    virtual RID joint_create_slider(
        RID p_body_A,
        const Transform& p_local_frame_A,
        RID p_body_B,
        const Transform& p_local_frame_B
    ) = 0; // reference frame is A

    virtual void slider_joint_set_param(
        RID p_joint,
        SliderJointParam p_param,
        float p_value
    ) = 0;
    virtual float slider_joint_get_param(RID p_joint, SliderJointParam p_param)
        const = 0;
    ...
    virtual RID joint_create_cone_twist(
        RID p_body_A,
        const Transform& p_local_frame_A,
        RID p_body_B,
        const Transform& p_local_frame_B
    ...
    virtual void cone_twist_joint_set_param(
        RID p_joint,
        ConeTwistJointParam p_param,
        float p_value
    ) = 0;
    virtual float cone_twist_joint_get_param(
        RID p_joint,
        ConeTwistJointParam p_param
    ) const = 0;
    ...
    virtual RID joint_create_generic_6dof(
        RID p_body_A,
        const Transform& p_local_frame_A,
        RID p_body_B,
        const Transform& p_local_frame_B
    ...
    virtual void generic_6dof_joint_set_param(
        RID p_joint,
        Vector3::Axis,
        G6DOFJointAxisParam p_param,
        float p_value
    ) = 0;
    virtual float generic_6dof_joint_get_param(
        RID p_joint,
        Vector3::Axis,
        G6DOFJointAxisParam p_param
    ) = 0;

    virtual void generic_6dof_joint_set_flag(
        RID p_joint,
        Vector3::Axis,
        G6DOFJointAxisFlag p_flag,
        bool p_enable
    ) = 0;
    virtual bool generic_6dof_joint_get_flag(
        RID p_joint,
        Vector3::Axis,
        G6DOFJointAxisFlag p_flag
    ) = 0;
...
public:
    PhysicsServer::MotionResult* get_result_ptr() const {
        return const_cast<PhysicsServer::MotionResult*>(&result);
    }
...
class PhysicsServerManager {
    struct ClassInfo {
        ...
        ClassInfo() : name(""), create_callback(nullptr) {}

        ClassInfo(
            String p_name,
            CreatePhysicsServerCallback p_create_callback
        ) :
            name(p_name),
