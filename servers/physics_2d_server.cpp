...
void Physics2DDirectBodyState::_bind_methods() {
    ...
    ClassDB::bind_method(
        ...
        &Physics2DDirectBodyState::get_velocity_at_local_position
    );
    ...
    ClassDB::bind_method(
        D_METHOD("add_force", "offset", "force"),
    ...
    ClassDB::bind_method(
        D_METHOD("apply_central_impulse", "impulse"),
        &Physics2DDirectBodyState::apply_central_impulse
    );
    ClassDB::bind_method(
        D_METHOD("apply_torque_impulse", "impulse"),
        &Physics2DDirectBodyState::apply_torque_impulse
    );
    ClassDB::bind_method(
        D_METHOD("apply_impulse", "offset", "impulse"),
    ...
    ClassDB::bind_method(
        D_METHOD("get_contact_collider_shape_metadata", "contact_idx"),
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::REAL, "inverse_inertia"),
        "",
        "get_inverse_inertia"
    );
    ADD_PROPERTY(
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "total_gravity"),
        "",
        "get_total_gravity"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::REAL, "angular_velocity"),
        "set_angular_velocity",
        "get_angular_velocity"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "linear_velocity"),
        "set_linear_velocity",
        "get_linear_velocity"
    );
    ADD_PROPERTY(
...
void Physics2DShapeQueryParameters::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("set_collision_layer", "collision_layer"),
        &Physics2DShapeQueryParameters::set_collision_mask
    );
    ClassDB::bind_method(
        D_METHOD("get_collision_layer"),
        &Physics2DShapeQueryParameters::get_collision_mask
    );
    ...
    ClassDB::bind_method(
        ...
        &Physics2DShapeQueryParameters::set_collide_with_bodies
    );
    ClassDB::bind_method(
        D_METHOD("is_collide_with_bodies_enabled"),
        &Physics2DShapeQueryParameters::is_collide_with_bodies_enabled
    );

    ClassDB::bind_method(
        D_METHOD("set_collide_with_areas", "enable"),
        &Physics2DShapeQueryParameters::set_collide_with_areas
    );
    ClassDB::bind_method(
        D_METHOD("is_collide_with_areas_enabled"),
        &Physics2DShapeQueryParameters::is_collide_with_areas_enabled
    );
    ...
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "motion"),
        "set_motion",
        "get_motion"
    );
...
Array Physics2DDirectSpaceState::_intersect_shape(
    const Ref<Physics2DShapeQueryParameters>& p_shape_query,
    int p_max_results
) {
...
Array Physics2DDirectSpaceState::_cast_motion(
    const Ref<Physics2DShapeQueryParameters>& p_shape_query
) {
    ERR_FAIL_COND_V(!p_shape_query.is_valid(), Array());
...
Array Physics2DDirectSpaceState::_intersect_point_impl(
    ...
    if (p_filter_by_canvas) {
        ...
        rc = intersect_point_on_canvas(
            p_point,
            p_canvas_instance_id,
            ret.ptrw(),
            ret.size(),
            exclude,
            p_layers,
...
Array Physics2DDirectSpaceState::_intersect_point(
    const Vector2& p_point,
    int p_max_results,
    const Vector<RID>& p_exclude,
    uint32_t p_layers,
...
Array Physics2DDirectSpaceState::_intersect_point_on_canvas(
    const Vector2& p_point,
    ObjectID p_canvas_intance_id,
    int p_max_results,
    const Vector<RID>& p_exclude,
    uint32_t p_layers,
    bool p_collide_with_bodies,
...
Array Physics2DDirectSpaceState::_collide_shape(
    const Ref<Physics2DShapeQueryParameters>& p_shape_query,
    int p_max_results
) {
    ERR_FAIL_COND_V(!p_shape_query.is_valid(), Array());
...
Dictionary Physics2DDirectSpaceState::_get_rest_info(
    const Ref<Physics2DShapeQueryParameters>& p_shape_query
) {
...
void Physics2DDirectSpaceState::_bind_methods() {
    ClassDB::bind_method(
        ...
        &Physics2DDirectSpaceState::_intersect_point,
        DEFVAL(32),
        DEFVAL(Array()),
        DEFVAL(0x7FFFFFFF),
        DEFVAL(true),
    ...
    ClassDB::bind_method(
        ...
        &Physics2DDirectSpaceState::_intersect_point_on_canvas,
        DEFVAL(32),
        DEFVAL(Array()),
        DEFVAL(0x7FFFFFFF),
        DEFVAL(true),
    ...
    ClassDB::bind_method(
        ...
        &Physics2DDirectSpaceState::_intersect_ray,
        DEFVAL(Array()),
        DEFVAL(0x7FFFFFFF),
        DEFVAL(true),
        DEFVAL(false)
    ...
    ClassDB::bind_method(
        ...
        &Physics2DDirectSpaceState::_intersect_shape,
        DEFVAL(32)
    );
    ClassDB::bind_method(
        D_METHOD("cast_motion", "shape"),
        &Physics2DDirectSpaceState::_cast_motion
    );
    ClassDB::bind_method(
        D_METHOD("collide_shape", "shape", "max_results"),
        &Physics2DDirectSpaceState::_collide_shape,
        DEFVAL(32)
    );
    ClassDB::bind_method(
        D_METHOD("get_rest_info", "shape"),
        &Physics2DDirectSpaceState::_get_rest_info
    );
}
...
void Physics2DTestMotionResult::_bind_methods() {
    ...
    ClassDB::bind_method(
        ...
        &Physics2DTestMotionResult::get_collision_depth
    );
    ClassDB::bind_method(
        D_METHOD("get_collision_safe_fraction"),
        &Physics2DTestMotionResult::get_collision_safe_fraction
    );
    ClassDB::bind_method(
        D_METHOD("get_collision_unsafe_fraction"),
        &Physics2DTestMotionResult::get_collision_unsafe_fraction
    );

    ADD_PROPERTY(PropertyInfo(Variant::VECTOR2, "motion"), "", "get_motion");
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "motion_remainder"),
        "",
        "get_motion_remainder"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "collision_point"),
        "",
        "get_collision_point"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "collision_normal"),
        "",
        "get_collision_normal"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::VECTOR2, "collider_velocity"),
        "",
...
bool Physics2DServer::_body_test_motion(
    RID p_body,
    const Transform2D& p_from,
    const Vector2& p_motion,
    bool p_infinite_inertia,
    float p_margin,
    const Ref<Physics2DTestMotionResult>& p_result,
...
void Physics2DServer::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("area_attach_canvas_instance_id", "area", "id"),
        &Physics2DServer::area_attach_canvas_instance_id
    );
    ClassDB::bind_method(
        D_METHOD("area_get_canvas_instance_id", "area"),
    ...
    ClassDB::bind_method(
        D_METHOD("body_set_shape_metadata", "body", "shape_idx", "metadata"),
    ...
    ClassDB::bind_method(
        D_METHOD("body_get_shape_metadata", "body", "shape_idx"),
    ...
    ClassDB::bind_method(
        D_METHOD("body_attach_canvas_instance_id", "body", "id"),
        &Physics2DServer::body_attach_canvas_instance_id
    );
    ClassDB::bind_method(
        D_METHOD("body_get_canvas_instance_id", "body"),
    ...
    ClassDB::bind_method(
        D_METHOD("body_get_continuous_collision_detection_mode", "body"),
    ...
    ClassDB::bind_method(
        D_METHOD("body_add_force", "body", "offset", "force"),
    ...
    ClassDB::bind_method(
        ...
        &Physics2DServer::_body_test_motion,
        DEFVAL(0.08),
        DEFVAL(Variant()),
        DEFVAL(true),
        DEFVAL(Array())
    ...
    ClassDB::bind_method(
        D_METHOD("joint_set_param", "joint", "param", "value"),
        &Physics2DServer::joint_set_param
    );
    ClassDB::bind_method(
        D_METHOD("joint_get_param", "joint", "param"),
        &Physics2DServer::joint_get_param
    );

    ClassDB::bind_method(
        D_METHOD("pin_joint_create", "anchor", "body_a", "body_b"),
    ...
    ClassDB::bind_method(
        D_METHOD("damped_string_joint_set_param", "joint", "param", "value"),
        &Physics2DServer::damped_string_joint_set_param
    );
    ClassDB::bind_method(
        D_METHOD("damped_string_joint_get_param", "joint", "param"),
    ...
    ClassDB::bind_method(
        ...
        &Physics2DServer::set_collision_iterations
    );
...
void Physics2DServerManager::register_server(
    const String& p_name,
    CreatePhysics2DServerCallback p_creat_callback
) {
...
void Physics2DServerManager::set_default_server(
    const String& p_name,
    int p_priority
) {
