...
typedef enum {
    ...
    GODOT_ERR_UNCONFIGURED, ///< The object being used hasn't been properly set
                            ///< up yet
    ...
    GODOT_ERR_DOES_NOT_EXIST,     ///< When retrieving/erasing, it item does not
                                  ///< exist
    ...
    GODOT_ERR_BUG,  ///< a bug in the software certainly happened, due to a
                    ///< double check failing or unexpected behavior.
    GODOT_ERR_PRINTER_ON_FIRE, /// the parallel port printer is engulfed in
                               /// flames
} godot_error;
...
typedef struct {
    ...
    godot_object* gd_native_library; // pointer to GDNativeLibrary that is being
                                     // initialized
...
godot_object GDAPI* godot_object_cast_to(
