...
public:
    ...
    /// If you pass as p_area the SpaceBullet you can set some parameters as
    /// specified below AREA_PARAM_GRAVITY AREA_PARAM_GRAVITY_VECTOR Otherwise
    /// you can set area parameters
    void area_set_param(
        RID p_area,
    ...
    void pin_joint_set_param(RID p_joint, PinJointParam p_param, float p_value)
        override;
    float pin_joint_get_param(RID p_joint, PinJointParam p_param)
        const override;
    ...
    float hinge_joint_get_param(RID p_joint, HingeJointParam p_param)
        const override;
    ...
    float slider_joint_get_param(RID p_joint, SliderJointParam p_param)
        const override;
    ...
    float cone_twist_joint_get_param(RID p_joint, ConeTwistJointParam p_param)
        const override;
    ...
    float generic_6dof_joint_get_param(
        RID p_joint,
        Vector3::Axis p_axis,
        G6DOFJointAxisParam p_param
    ) override;
