...
private:
    ...
    btSoftBody::Material*
        mat0; // This is just a copy of pointer managed by btSoftBody
    bool isScratched;
    ...
    // btScalar				kVC;			// Volume conversation coefficient
    // [0,+inf] btScalar				kDF;			// Dynamic friction
    // coefficient [0,1] btScalar				kMT;			// Pose matching
    // coefficient [0,1] btScalar				kCHR;			// Rigid
    // contacts hardness [0,1] btScalar				kKHR;			// Kinetic
    // contacts hardness [0,1] btScalar				kSHR;			// Soft
    // contacts hardness [0,1]
...
private:
    void set_trimesh_body_shape(
        PoolVector<int> p_indices,
        PoolVector<Vector3> p_vertices
    );
