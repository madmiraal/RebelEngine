...
class BulletPhysicsDirectSpaceState : public PhysicsDirectSpaceState {
    REBEL_OBJECT(BulletPhysicsDirectSpaceState, PhysicsDirectSpaceState);
...
public:
    ...
    _FORCE_INLINE_ btBroadphaseInterface* get_broadphase() {
        return broadphase;
    }
    ...
    _FORCE_INLINE_ btSoftBodyWorldInfo* get_soft_body_world_info() {
    ...
    /// @param p_param:
    ///     AREA_PARAM_GRAVITY          to set the gravity magnitude of entire
    ///     world AREA_PARAM_GRAVITY_VECTOR   to set the gravity direction of
    ///     entire world
    void set_param(
    ...
    /// @param p_param:
    ///     AREA_PARAM_GRAVITY          to get the gravity magnitude of entire
    ///     world AREA_PARAM_GRAVITY_VECTOR   to get the gravity direction of
    ///     entire world
...
private:
    ...
    /// this API we don't benefit of Bullet special accelerated functions
    bool RFP_convex_convex_test(
    ...
    /// This is an API that recover a kinematic object from penetration
    /// Using this we leave Bullet to select the best algorithm, For example GJK
    /// in case we have Convex Convex, or a Bullet accelerated algorithm
