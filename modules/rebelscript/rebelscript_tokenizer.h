...
#ifndef REBELSCRIPT_TOKENIZER_H
#define REBELSCRIPT_TOKENIZER_H
...
public:
    ...
    virtual RebelScriptFunctions::Function get_token_built_in_func(
        int p_offset = 0
    ) const                                                       = 0;
    ...
    virtual ~RebelScriptTokenizer(){};
};

class RebelScriptTokenizerText : public RebelScriptTokenizer {
    enum {
        MAX_LOOKAHEAD = 4,
    ...
    struct TokenData {
        ...
        union {
            ...
            RebelScriptFunctions::Function
                func;         // function for built in functions
    ...
    void _make_built_in_func(RebelScriptFunctions::Function p_func);
...
class RebelScriptTokenizerBuffer : public RebelScriptTokenizer {
    enum {
...
#endif // DEBUG_ENABLED
    RebelScriptTokenizerBuffer();
};

#endif // REBELSCRIPT_TOKENIZER_H
