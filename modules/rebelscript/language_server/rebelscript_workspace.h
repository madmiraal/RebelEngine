...
#ifndef REBELSCRIPT_WORKSPACE_H
#define REBELSCRIPT_WORKSPACE_H
...
class RebelScriptWorkspace : public Reference {
    GDCLASS(RebelScriptWorkspace, Reference);
...
protected:
    ...
    ExtendRebelScriptParser* get_parse_successed_script(const String& p_path);
    ExtendRebelScriptParser* get_parse_result(const String& p_path);
...
public:
    ...
    Map<String, ExtendRebelScriptParser*> scripts;
    Map<String, ExtendRebelScriptParser*> parse_results;
...
public:
    ...
    RebelScriptWorkspace();
    ~RebelScriptWorkspace();
};

#endif // REBELSCRIPT_WORKSPACE_H
