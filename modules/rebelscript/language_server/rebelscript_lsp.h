...
#ifndef REBELSCRIPT_LSP_H
#define REBELSCRIPT_LSP_H
...
struct RebelCapabilities {
    /**
     * Native class list
     */
    List<RebelNativeClassInfo> native_classes;

    Dictionary to_json() {
        Dictionary dict;
        Array classes;
        for (List<RebelNativeClassInfo>::Element* E = native_classes.front(); E;
             E                                      = E->next()) {
