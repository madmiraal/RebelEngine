...
#ifndef REBELSCRIPT_TEXT_DOCUMENT_H
#define REBELSCRIPT_TEXT_DOCUMENT_H

#include "core/os/file_access.h"
#include "core/reference.h"
#include "rebelscript_lsp.h"

class RebelScriptTextDocument : public Reference {
    GDCLASS(RebelScriptTextDocument, Reference)
...
public:
    ...
    RebelScriptTextDocument();
    virtual ~RebelScriptTextDocument();
};

#endif // REBELSCRIPT_TEXT_DOCUMENT_H
