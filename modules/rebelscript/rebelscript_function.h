...
#ifndef REBELSCRIPT_FUNCTION_H
#define REBELSCRIPT_FUNCTION_H
...
private:
    ...
    Vector<int> code;
    Vector<RebelScriptDataType> argument_types;
    RebelScriptDataType return_type;
    ...
    SelfList<RebelScriptFunction> function_list;
#ifdef DEBUG_ENABLED
...
public:
    ...
    RebelScriptDataType get_return_type() const;
    RebelScriptDataType get_argument_type(int p_idx) const;

    RebelScript* get_script() const {
        return _script;
    }
...
class RebelScriptFunctionState : public Reference {
    GDCLASS(RebelScriptFunctionState, Reference);
    friend class RebelScriptFunction;
    RebelScriptFunction* function;
    RebelScriptFunction::CallState state;
    Variant _signal_callback(
        const Variant** p_args,
        int p_argcount,
        Variant::CallError& r_error
    );
    Ref<RebelScriptFunctionState> first_state;

    SelfList<RebelScriptFunctionState> scripts_list;
    SelfList<RebelScriptFunctionState> instances_list;
