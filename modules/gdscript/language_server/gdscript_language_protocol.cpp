...
Error GDScriptLanguageProtocol::LSPeer::handle_data() {
    ...
    if (has_header) {
        ...
        // Response
        String output =
            GDScriptLanguageProtocol::get_singleton()->process_message(msg);
        if (!output.empty()) {
...
void GDScriptLanguageProtocol::_bind_methods() {
    ...
    ClassDB::bind_method(
        ...
        &GDScriptLanguageProtocol::initialized
    );
    ClassDB::bind_method(
    ...
    ClassDB::bind_method(
        ...
        &GDScriptLanguageProtocol::on_client_disconnected
    );
    ClassDB::bind_method(
    ...
    ClassDB::bind_method(
        ...
        &GDScriptLanguageProtocol::is_smart_resolve_enabled
    );
    ClassDB::bind_method(
    ...
    ClassDB::bind_method(
        ...
        &GDScriptLanguageProtocol::is_initialized
    );
}
...
Dictionary GDScriptLanguageProtocol::initialize(const Dictionary& p_params) {
    ...
    if (root_uri.length() && is_same_workspace) {
        ...
        Dictionary request =
            make_notification("gdscript_client/changeWorkspace", params);
...
void GDScriptLanguageProtocol::notify_client(
...
void GDScriptLanguageProtocol::request_client(
    const String& p_method,
    const Variant& p_params,
    int p_client_id
) {
