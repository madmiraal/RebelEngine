...
namespace Rebel.Collections
{
    internal class ArraySafeHandle : SafeHandle
    {
        ...
        {
            Array.rebel_icall_Array_Dtor(handle);
            return true;
        }
    }

    /// <summary>
    /// Wrapper around Rebel's Array class, an array of Variant
    ...
    public class Array : IList, IDisposable
    {
        ...
        public Array()
        {
            _safeHandle = new ArraySafeHandle(rebel_icall_Array_Ctor());
        }
        ...
        /// <returns>A new Rebel Array.</returns>
        ...
        public Array(params object[] array) : this()
        {
            ...
            _safeHandle = new ArraySafeHandle(rebel_icall_Array_Ctor_MonoArray(array));
        }
        ...
        {
            return new Array(rebel_icall_Array_Duplicate(GetPtr(), deep));
        }
        ...
        {
            return rebel_icall_Array_Resize(GetPtr(), newSize);
        }
        ...
        public void Shuffle()
        {
            rebel_icall_Array_Shuffle(GetPtr());
        }
        ...
        /// <returns>A new Rebel Array with the contents of both arrays.</returns>
        public static Array operator +(Array left, Array right)
        {
            return new Array(rebel_icall_Array_Concatenate(left.GetPtr(), right.GetPtr()));
        }
        ...
        {
            get => rebel_icall_Array_At(GetPtr(), index);
            set => rebel_icall_Array_SetAt(GetPtr(), index, value);
        }
        ...
        public int Add(object value) => rebel_icall_Array_Add(GetPtr(), value);
        ...
        public bool Contains(object value) => rebel_icall_Array_Contains(GetPtr(), value);

        /// <summary>
        /// Erases all items from this <see cref="Array"/>.
        /// </summary>
        public void Clear() => rebel_icall_Array_Clear(GetPtr());
        ...
        public int IndexOf(object value) => rebel_icall_Array_IndexOf(GetPtr(), value);
        ...
        public void Insert(int index, object value) => rebel_icall_Array_Insert(GetPtr(), index, value);
        ...
        public void Remove(object value) => rebel_icall_Array_Remove(GetPtr(), value);

        /// <summary>
        /// Removes an element from this <see cref="Array"/> by index.
        /// </summary>
        /// <param name="index">The index of the element to remove.</param>
        public void RemoveAt(int index) => rebel_icall_Array_RemoveAt(GetPtr(), index);
        ...
        public int Count => rebel_icall_Array_Count(GetPtr());
        ...
        public void CopyTo(System.Array array, int index)
        {
            ...
            rebel_icall_Array_CopyTo(GetPtr(), array, index);
        }
        ...
        {
            return rebel_icall_Array_ToString(GetPtr());
        }

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr rebel_icall_Array_Ctor();

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr rebel_icall_Array_Ctor_MonoArray(System.Array array);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_Dtor(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object rebel_icall_Array_At(IntPtr ptr, int index);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern object rebel_icall_Array_At_Generic(IntPtr ptr, int index, int elemTypeEncoding, IntPtr elemTypeClass);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_SetAt(IntPtr ptr, int index, object value);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_Array_Count(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_Array_Add(IntPtr ptr, object item);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_Clear(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr rebel_icall_Array_Concatenate(IntPtr left, IntPtr right);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool rebel_icall_Array_Contains(IntPtr ptr, object item);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_CopyTo(IntPtr ptr, System.Array array, int arrayIndex);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern IntPtr rebel_icall_Array_Duplicate(IntPtr ptr, bool deep);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern int rebel_icall_Array_IndexOf(IntPtr ptr, object item);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_Insert(IntPtr ptr, int index, object item);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern bool rebel_icall_Array_Remove(IntPtr ptr, object item);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_RemoveAt(IntPtr ptr, int index);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern Error rebel_icall_Array_Resize(IntPtr ptr, int newSize);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern Error rebel_icall_Array_Shuffle(IntPtr ptr);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void rebel_icall_Array_Generic_GetElementTypeInfo(Type elemType, out int elemTypeEncoding, out IntPtr elemTypeClass);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern string rebel_icall_Array_ToString(IntPtr ptr);
    }

    /// <summary>
    /// Typed wrapper around Rebel's Array class, an array of Variant
    /// typed elements allocated in the engine in C++. Useful when
    /// interfacing with the engine. Otherwise prefer .NET collections
    ...
    public class Array<T> : IList<T>, ICollection<T>, IEnumerable<T>
    {
        ...
        static Array()
        {
            Array.rebel_icall_Array_Generic_GetElementTypeInfo(typeof(T), out elemTypeEncoding, out elemTypeClass);
        }
        ...
        {
            get { return (T)Array.rebel_icall_Array_At_Generic(GetPtr(), index, elemTypeEncoding, elemTypeClass); }
        ...
        {
            return Array.rebel_icall_Array_Remove(GetPtr(), item);
        }
