...
namespace Rebel
{
    ...
    /// https://docs.rebeltoolbox.com/en/latest/tutorials/math/matrices_and_transforms.html
    /// </summary>
    [Serializable]
    ...
    public struct Basis : IEquatable<Basis>
    {
        ...
        /// returns a <see cref="Rebel.Quat"/> quaternion instead of Euler angles.
        /// </summary>
        ...
        ///
        /// For further details, refer to the Rebel source code.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Rebel.Quat"/> representing the basis's rotation.</returns>
        public Quat Quat()
        {
        ...
        /// uses a <see cref="Rebel.Quat"/> quaternion instead of Euler angles.
        /// </summary>
