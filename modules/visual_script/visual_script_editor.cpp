...
protected:
    ...
    bool _set(const StringName& p_name, const Variant& p_value) {
            ...
            if (new_argc < argc) {
                for (int i = new_argc; i < argc; i++) {
                    ...
                    undo_redo->add_undo_method(
                        ...
                        script->custom_signal_get_argument_type(sig, i),
                        -1
                    );
                }
        ...
        if (String(p_name).begins_with("argument/")) {
            ...
            ERR_FAIL_INDEX_V(
                idx,
                script->custom_signal_get_argument_count(sig),
                false
            );
            String what = String(p_name).get_slice("/", 2);
            if (what == "type") {
                int old_type =
                    script->custom_signal_get_argument_type(sig, idx);
            ...
            if (what == "name") {
                String old_name =
                    script->custom_signal_get_argument_name(sig, idx);
    ...
    void _get_property_list(List<PropertyInfo>* p_list) const {
        ...
        for (int i = 0; i < script->custom_signal_get_argument_count(sig);
             i++) {
            p_list->push_back(PropertyInfo(
                Variant::INT,
...
protected:
    ...
    void _var_value_changed() {
        _change_notify("value"); // so the whole tree is not redrawn, makes
                                 // editing smoother in general
        emit_signal("changed");
    }
    ...
    bool _set(const StringName& p_name, const Variant& p_value) {
        ...
        if (String(p_name) == "type") {
            ...
            undo_redo
                ->add_do_method(script.ptr(), "set_variable_info", var, dc);
            undo_redo
                ->add_undo_method(script.ptr(), "set_variable_info", var, d);
    ...
    void _get_property_list(List<PropertyInfo>* p_list) const {
        ...
        p_list->push_back(PropertyInfo(
            script->get_variable_info(var).type,
            "value",
        ...
        p_list->push_back(PropertyInfo(
            ...
            "hint",
            PROPERTY_HINT_ENUM,
            "None,Range,ExpRange,Enum,ExpEasing,Length,SpriteFrame,KeyAccel,"
            "Flags,Layers2dRender,Layers2dPhysics,Layer3dRender,Layer3dPhysics,"
            "File,Dir,GlobalFile,GlobalDir,ResourceType,MultilineText,"
            "PlaceholderText,ColorNoAlpha,ImageCompressLossy,"
            "ImageCompressLossLess,ObjectId,TypeString,NodePathToEditedNode,"
            "MethodOfVariantType,MethodOfBaseType,MethodOfInstance,"
            "MethodOfScript,PropertyOfVariantType,PropertyOfBaseType,"
            "PropertyOfInstance,PropertyOfScript,ObjectTooBig,"
            "NodePathValidTypes,SaveFile"
        ));
...
static Color _color_from_type(Variant::Type p_type, bool dark_theme = true) {
    ...
    if (dark_theme) {
        switch (p_type) {
            case Variant::NIL:
                color = Color(0.41f, 0.93f, 0.74f);
                break;

            case Variant::BOOL:
                color = Color(0.55f, 0.65f, 0.94f);
                break;
            case Variant::INT:
                color = Color(0.49f, 0.78f, 0.94f);
                break;
            case Variant::REAL:
                color = Color(0.38f, 0.85f, 0.96f);
                break;
            case Variant::STRING:
                color = Color(0.42f, 0.65f, 0.93f);
                break;

            case Variant::VECTOR2:
                color = Color(0.74f, 0.57f, 0.95f);
                break;
            case Variant::RECT2:
                color = Color(0.95f, 0.57f, 0.65f);
                break;
            case Variant::VECTOR3:
                color = Color(0.84f, 0.49f, 0.93f);
                break;
            case Variant::TRANSFORM2D:
                color = Color(0.77f, 0.93f, 0.41f);
                break;
            case Variant::PLANE:
                color = Color(0.97f, 0.44f, 0.44f);
                break;
            case Variant::QUAT:
                color = Color(0.93f, 0.41f, 0.64f);
                break;
            case Variant::AABB:
                color = Color(0.93f, 0.47f, 0.57f);
                break;
            case Variant::BASIS:
                color = Color(0.89f, 0.93f, 0.41f);
                break;
            case Variant::TRANSFORM:
                color = Color(0.96f, 0.66f, 0.43f);
                break;

            case Variant::COLOR:
                color = Color(0.62f, 1.0f, 0.44f);
                break;
            case Variant::NODE_PATH:
                color = Color(0.41f, 0.58f, 0.93f);
                break;
            case Variant::_RID:
                color = Color(0.41f, 0.93f, 0.6f);
                break;
            case Variant::OBJECT:
                color = Color(0.47f, 0.95f, 0.91f);
                break;
            case Variant::DICTIONARY:
                color = Color(0.47f, 0.93f, 0.69f);
                break;

            case Variant::ARRAY:
                color = Color(0.88f, 0.88f, 0.88f);
                break;
            case Variant::POOL_BYTE_ARRAY:
                color = Color(0.67f, 0.96f, 0.78f);
                break;
            case Variant::POOL_INT_ARRAY:
                color = Color(0.69f, 0.86f, 0.96f);
                break;
            case Variant::POOL_REAL_ARRAY:
                color = Color(0.59f, 0.91f, 0.97f);
                break;
            case Variant::POOL_STRING_ARRAY:
                color = Color(0.62f, 0.77f, 0.95f);
                break;
            case Variant::POOL_VECTOR2_ARRAY:
                color = Color(0.82f, 0.7f, 0.96f);
                break;
            case Variant::POOL_VECTOR3_ARRAY:
                color = Color(0.87f, 0.61f, 0.95f);
                break;
            case Variant::POOL_COLOR_ARRAY:
                color = Color(0.91f, 1.0f, 0.59f);
                break;
        ...
        switch (p_type) {
            case Variant::NIL:
                color = Color(0.15f, 0.89f, 0.63f);
                break;

            case Variant::BOOL:
                color = Color(0.43f, 0.56f, 0.92f);
                break;
            case Variant::INT:
                color = Color(0.31f, 0.7f, 0.91f);
                break;
            case Variant::REAL:
                color = Color(0.15f, 0.8f, 0.94f);
                break;
            case Variant::STRING:
                color = Color(0.27f, 0.56f, 0.91f);
                break;

            case Variant::VECTOR2:
                color = Color(0.68f, 0.46f, 0.93f);
                break;
            case Variant::RECT2:
                color = Color(0.93f, 0.46f, 0.56f);
                break;
            case Variant::VECTOR3:
                color = Color(0.86f, 0.42f, 0.93f);
                break;
            case Variant::TRANSFORM2D:
                color = Color(0.59f, 0.81f, 0.1f);
                break;
            case Variant::PLANE:
                color = Color(0.97f, 0.44f, 0.44f);
                break;
            ...
            case Variant::AABB:
                ...
                break;
            case Variant::BASIS:
                color = Color(0.7f, 0.73f, 0.1f);
                break;
            case Variant::TRANSFORM:
                color = Color(0.96f, 0.56f, 0.28f);
                break;

            case Variant::COLOR:
                color = Color(0.24f, 0.75f, 0.0f);
                break;
            case Variant::NODE_PATH:
                color = Color(0.41f, 0.58f, 0.93f);
                break;
            case Variant::_RID:
                color = Color(0.17f, 0.9f, 0.45f);
                break;
            case Variant::OBJECT:
                color = Color(0.07f, 0.84f, 0.76f);
                break;
            case Variant::DICTIONARY:
                color = Color(0.34f, 0.91f, 0.62f);
                break;

            case Variant::ARRAY:
                color = Color(0.45f, 0.45f, 0.45f);
                break;
            case Variant::POOL_BYTE_ARRAY:
                color = Color(0.38f, 0.92f, 0.6f);
                break;
            case Variant::POOL_INT_ARRAY:
                color = Color(0.38f, 0.73f, 0.92f);
                break;
            case Variant::POOL_REAL_ARRAY:
                color = Color(0.25f, 0.83f, 0.95f);
                break;
            case Variant::POOL_STRING_ARRAY:
                color = Color(0.38f, 0.62f, 0.92f);
                break;
            case Variant::POOL_VECTOR2_ARRAY:
                color = Color(0.62f, 0.36f, 0.92f);
                break;
            case Variant::POOL_VECTOR3_ARRAY:
                color = Color(0.79f, 0.35f, 0.92f);
                break;
            case Variant::POOL_COLOR_ARRAY:
                color = Color(0.57f, 0.73f, 0.0f);
                break;
...
void VisualScriptEditor::_update_graph_connections() {
    ...
    for (List<StringName>::Element* F = funcs.front(); F; F = F->next()) {
        ...
        for (List<VisualScript::SequenceConnection>::Element* E =
                 sequence_conns.front();
             E;
             E = E->next()) {
            graph->connect_node(
                itos(E->get().from_node),
                E->get().from_output,
                itos(E->get().to_node),
                0
            );
        ...
        for (List<VisualScript::DataConnection>::Element* E =
                 data_conns.front();
             E;
             E = E->next()) {
            ...
            Ref<VisualScriptNode> from_node =
                script->get_node(F->get(), E->get().from_node);
            Ref<VisualScriptNode> to_node =
                script->get_node(F->get(), E->get().to_node);
...
void VisualScriptEditor::_update_graph(int p_only_id) {
    ...
    Ref<Texture> seq_port =
        Control::get_icon("VisualShaderPort", "EditorIcons");

    for (List<StringName>::Element* F = funcs.front(); F;
         F = F->next()) { // loop through all the functions
        ...
        for (List<int>::Element* E = ids.front(); E; E = E->next()) {
            ...
            if (is_vslist) {
                ...
                line_edit->add_font_override(
                    "font",
                    get_font("source", "EditorFonts")
                );
                gnode->add_child(line_edit);
                line_edit->connect(
                    "text_changed",
                    this,
                    "_expression_text_changed",
                    varray(E->get())
                );
            } else {
            ...
            if (node_styles.has(node->get_category())) {
                ...
                if (gnode->is_comment()) {
                    sbf = EditorNode::get_singleton()
                              ->get_theme_base()
                              ->get_theme()
                              ->get_stylebox("comment", "GraphNode");
                }
            ...
            bool single_seq_output =
                node->get_output_sequence_port_count() == 1
                && node->get_output_sequence_port_text(0) == String();
            if ((node->has_input_sequence_port() || single_seq_output)
                || has_gnode_text) {
                // IF has_gnode_text is true BUT we have no sequence ports to
                // draw (in here), we still draw the disabled default ones to
                // shift up the slots by one, so the slots DON'T start with the
                // content text.

                // IF has_gnode_text is false, but we DO want to draw default
                // sequence ports, we draw a dummy text to take up the position
                // of the sequence nodes, so all the other ports are still
                // aligned correctly.
                if (!has_gnode_text) {
            ...
            if (!single_seq_output) {
                if (node->has_mixed_input_and_sequence_ports()) {
                    ...
                    for (int i = 0; i < node->get_output_sequence_port_count();
                         i++) {
            ...
            for (int i = 0;
                 i < MAX(
                     node->get_output_value_port_count(),
                ...
                if (i >= mixed_seq_ports
                    && i < node->get_output_value_port_count()
                               + mixed_seq_ports) {
                    PropertyInfo pi =
                        node->get_output_value_port_info(i - mixed_seq_ports);
                    right_ok   = true;
                    right_type = pi.type;
                    right_name = pi.name;
                }
                ...
                if (left_ok) {
                    ...
                    if (is_vslist) {
                        if (nd_list->is_input_port_name_editable()) {
                            ...
                            name_box->set_custom_minimum_size(
                                Size2(60 * EDSCALE, 0)
                            );
                        ...
                        if (nd_list->is_input_port_type_editable()) {
                            ...
                            for (int j = Variant::NIL; j < Variant::VARIANT_MAX;
                                 j++) {
                                opbtn->add_item(
                                    Variant::get_type_name(Variant::Type(j))
                                );
                            }
                            opbtn->select(left_type);
                            opbtn->set_custom_minimum_size(
                                Size2(100 * EDSCALE, 0)
                            );
                            hbc->add_child(opbtn);
                            opbtn->connect(
                        ...
                        rmbtn->set_icon(EditorNode::get_singleton()
                                            ->get_gui_base()
                    ...
                    if (left_type != Variant::NIL
                        && !script->is_input_value_port_connected(
                            F->get(),
                            E->get(),
                            i
                        )) {
                ...
                if (i < mixed_seq_ports) {
                    gnode->set_slot(
                        ...
                        left_ok,
                        left_type,
                        _color_from_type(left_type, dark_theme),
                        true,
                        TYPE_SEQUENCE,
                        mono_color,
                        Ref<Texture>(),
                    ...
                    gnode->set_slot(
                        ...
                        right_ok,
                        right_type,
                        _color_from_type(right_type, dark_theme)
                    );
                }
    ...
    graph->call_deferred(
        "set_scroll_ofs",
        script->get_function_scroll(default_func) * EDSCALE
    );
    updating_graph = false;
}

void VisualScriptEditor::_change_port_type(
    int p_select,
    int p_id,
    int p_port,
    bool is_input
...
void VisualScriptEditor::_update_node_size(int p_id) {
    ...
    if (Object::cast_to<Control>(node)) {
        Object::cast_to<Control>(node)->set_size(Vector2(1, 1)
        ); // shrink if text is smaller
    }
}

void VisualScriptEditor::_port_name_focus_out(
    const Node* p_name_box,
    int p_id,
    int p_port,
    bool is_input
) {
...
void VisualScriptEditor::_update_members() {
    ...
    functions->add_button(
        0,
        Control::get_icon("Override", "EditorIcons"),
        1,
        false,
        TTR("Override an existing built-in function.")
    );
    functions->add_button(
        0,
        Control::get_icon("Add", "EditorIcons"),
        0,
        false,
    ...
    for (List<StringName>::Element* E = signal_names.front(); E;
         E                            = E->next()) {
...
String VisualScriptEditor::_sanitized_variant_text(
    ...
    if (script->get_variable_info(property_name).type != Variant::NIL) {
        ...
        var                      = Variant::construct(
            script->get_variable_info(property_name).type,
            &converted,
            1,
            ce,
            false
...
void VisualScriptEditor::_member_edited() {
    ...
    if (ti->get_parent() == root->get_children()) {
        ...
        undo_redo
            ->add_do_method(script.ptr(), "rename_function", name, new_name);
        undo_redo
            ->add_undo_method(script.ptr(), "rename_function", new_name, name);
        if (func.is_valid()) {
        ...
        for (List<StringName>::Element* E = flst.front(); E; E = E->next()) {
            ...
            for (List<int>::Element* F = lst.front(); F; F = F->next()) {
                Ref<VisualScriptFunctionCall> fncall =
                    script->get_node(E->get(), F->get());
                if (!fncall.is_valid()) {
                    continue;
                }
                if (fncall->get_function() == name) {
                    undo_redo
                        ->add_do_method(fncall.ptr(), "set_function", new_name);
                    undo_redo
                        ->add_undo_method(fncall.ptr(), "set_function", name);
                }
            }
        }
        ...
        undo_redo
            ->add_undo_method(this, "emit_signal", "edited_script_changed");
        undo_redo->commit_action();
    ...
    if (ti->get_parent() == root->get_children()->get_next()) {
        ...
        undo_redo
            ->add_do_method(script.ptr(), "rename_variable", name, new_name);
        undo_redo
            ->add_undo_method(script.ptr(), "rename_variable", new_name, name);
        undo_redo->add_do_method(this, "_update_members");
        undo_redo->add_undo_method(this, "_update_members");
        undo_redo->add_do_method(this, "emit_signal", "edited_script_changed");
        undo_redo
...
void VisualScriptEditor::_create_function() {
    String name = _validate_name(
        (func_name_box->get_text() == "") ? "new_func"
...
void VisualScriptEditor::_add_node_dialog() {
    _generic_search(
        ...
        graph->get_global_position() + Vector2(55, 80),
        true
    );
}
...
void VisualScriptEditor::_add_func_input() {
    ...
    delete_button->set_icon(EditorNode::get_singleton()
                                ->get_gui_base()
                                ->get_icon("Remove", "EditorIcons"));
...
void VisualScriptEditor::_member_button(
    Object* p_item,
    int p_column,
    int p_button
) {
    ...
    if (ti->get_parent() == root) {
        ...
        if (ti == root->get_children()) {
            ...
            if (p_button == 1) {
                ...
                undo_redo
                    ->add_undo_method(script.ptr(), "remove_function", name);
                undo_redo->add_do_method(this, "_update_members");
                undo_redo->add_undo_method(this, "_update_members");
                undo_redo->add_do_method(this, "_update_graph");
                undo_redo->add_undo_method(this, "_update_graph");
        ...
        if (ti == root->get_children()->get_next()) {
            ...
            undo_redo->add_undo_method(this, "_update_members");
            undo_redo
                ->add_do_method(this, "emit_signal", "edited_script_changed");
            undo_redo
                ->add_undo_method(this, "emit_signal", "edited_script_changed");
            undo_redo->commit_action();
            return; // or crash because it will become invalid
        ...
        if (ti == root->get_children()->get_next()->get_next()) {
            ...
            undo_redo
                ->add_undo_method(script.ptr(), "remove_custom_signal", name);
            undo_redo->add_do_method(this, "_update_members");
            undo_redo->add_undo_method(this, "_update_members");
            undo_redo
                ->add_do_method(this, "emit_signal", "edited_script_changed");
        ...
        function_name_edit->set_position(
            Input::get_singleton()->get_mouse_position() - Vector2(60, -10)
        );
...
void VisualScriptEditor::_remove_input_port(int p_id, int p_port) {
    ...
    script->get_input_value_port_connection_source(
        func,
        p_id,
        p_port,
        &conn_from,
...
void VisualScriptEditor::_remove_output_port(int p_id, int p_port) {
    ...
    for (const List<VisualScript::DataConnection>::Element* E =
             data_connections.front();
         E;
         E = E->next()) {
    ...
    for (const List<int>::Element* E = keys.front(); E; E = E->next()) {
        for (const Set<int>::Element* F = conn_map[E->get()].front(); F;
             F                          = F->next()) {
            undo_redo->add_undo_method(
                script.ptr(),
                "data_connect",
...
void VisualScriptEditor::_expression_text_changed(
    const String& p_text,
    int p_id
) {
    StringName func = _get_function_of_node(p_id);
    ...
    undo_redo
        ->add_undo_property(vse.ptr(), "expression", vse->get("expression"));
    undo_redo->add_do_method(this, "_update_graph", p_id);
    undo_redo->add_undo_method(this, "_update_graph", p_id);
    undo_redo->commit_action();
...
Vector2 VisualScriptEditor::_get_available_pos(bool p_centered, Vector2 p_pos)
    const {
    if (p_centered) {
...
void VisualScriptEditor::_on_nodes_copy() {
        ...
        if (gn) {
            if (gn->is_selected()) {
                ...
                if (node.is_valid()) {
                    ...
                    clipboard->nodes_positions[id] =
                        script->get_node_position(func, id);
    ...
    for (Set<String>::Element* F = funcs.front(); F; F = F->next()) {
        ...
        for (List<VisualScript::SequenceConnection>::Element* E =
                 sequence_connections.front();
             E;
             E = E->next()) {
            if (clipboard->nodes.has(E->get().from_node)
                && clipboard->nodes.has(E->get().to_node)) {
...
void VisualScriptEditor::_on_nodes_paste() {
...

    {
        ...
        for (List<StringName>::Element* F = functions.front(); F;
             F                            = F->next()) {
            List<int> nodes;
    ...
    for (Map<int, Ref<VisualScriptNode>>::Element* E = clipboard->nodes.front();
         E;
         E = E->next()) {
        ...
        if (first_paste) {
            position_offset =
                _get_pos_in_graph(
                    mouse_up_position - graph->get_global_position()
                )
                - paste_pos;
            first_paste = false;
        }
    ...
    for (Set<VisualScript::SequenceConnection>::Element* E =
             clipboard->sequence_connections.front();
         E;
         E = E->next()) {
        undo_redo->add_do_method(
            script.ptr(),
    ...
    for (Set<VisualScript::DataConnection>::Element* E =
             clipboard->data_connections.front();
         E;
         E = E->next()) {
        undo_redo->add_do_method(
            script.ptr(),
...
void VisualScriptEditor::_on_nodes_delete() {
    ...
    for (List<int>::Element* F = to_erase.front(); F; F = F->next()) {
        ...
        undo_redo->add_undo_method(
            ...
            func,
            cr_node,
            script->get_node(func, cr_node),
            script->get_node_position(func, cr_node)
        );
...
void VisualScriptEditor::_on_nodes_duplicate() {
    ...
    for (Set<int>::Element* F = to_duplicate.front(); F; F = F->next()) {
        // duplicate from the specific function but place it into the default
        // func as it would lack the connections
        ...
        undo_redo->add_do_method(
            ...
            new_id,
            dupe,
            script->get_node_position(func, F->get()) + Vector2(20, 20)
        );
        undo_redo->add_undo_method(
            script.ptr(),
            "remove_node",
    ...
    for (List<StringName>::Element* F = funcs.front(); F; F = F->next()) {
        ...
        for (List<VisualScript::SequenceConnection>::Element* E = seqs.front();
             E;
             E = E->next()) {
            if (to_duplicate.has(E->get().from_node)
                && to_duplicate.has(E->get().to_node)) {
                undo_redo->add_do_method(
                    script.ptr(),
                    "sequence_connect",
                    default_func,
        ...
        for (List<VisualScript::DataConnection>::Element* E = data.front(); E;
             E                                              = E->next()) {
            if (to_duplicate.has(E->get().from_node)
                && to_duplicate.has(E->get().to_node)) {
                undo_redo->add_do_method(
    ...
    if (to_select.size()) {
        EditorNode::get_singleton()->push_item(
            script->get_node(default_func, to_select.front()->get()).ptr()
        );
    }
}
...
void VisualScriptEditor::_generic_search(
    ...
    new_connect_node_select->select_from_visual_script(
        ...
        false,
        false
    ); // neither connecting nor reset text
...
void VisualScriptEditor::_graph_gui_input(const Ref<InputEvent>& p_event) {
    ...
    if (key.is_valid() && key->is_pressed()
        && key->get_button_mask() == BUTTON_RIGHT) {
...
void VisualScriptEditor::_members_gui_input(const Ref<InputEvent>& p_event) {
    ...
    if (btn.is_valid() && btn->is_doubleclick()) {
        ...
        if (ti
            && ti->get_parent()
                   == members->get_root()->get_children(
                   )) { // to check if it's a function
            _center_on_node(
                ti->get_metadata(0),
                script->get_function_node_id(ti->get_metadata(0))
            );
        }
    }
}

void VisualScriptEditor::_rename_function(
    const String& name,
...
Variant VisualScriptEditor::get_drag_data_fw(
...
bool VisualScriptEditor::can_drop_data_fw(
    const Point2& p_point,
...
#ifdef MACOS_ENABLED
                const_cast<VisualScriptEditor*>(this)->_show_hint(vformat(
                    TTR("Hold %s to drop a Getter. Hold Shift to drop a "
                        "generic signature."),
                    find_keycode_name(KEY_META)
                ));
#else
                const_cast<VisualScriptEditor*>(this)->_show_hint(
                    TTR("Hold Ctrl to drop a Getter. Hold Shift to drop a "
                        "generic signature.")
                );
#endif
            }
...
#ifdef MACOS_ENABLED
                const_cast<VisualScriptEditor*>(this)->_show_hint(vformat(
                    TTR("Hold %s to drop a simple reference to the node."),
                    find_keycode_name(KEY_META)
                ));
#else
                const_cast<VisualScriptEditor*>(this)->_show_hint(
...
#ifdef MACOS_ENABLED
                const_cast<VisualScriptEditor*>(this)->_show_hint(vformat(
                    TTR("Hold %s to drop a Variable Setter."),
                    find_keycode_name(KEY_META)
                ));
#else
                const_cast<VisualScriptEditor*>(this)->_show_hint(
...
static Node* _find_script_node(
    ...
    for (int i = 0; i < p_current_node->get_child_count(); i++) {
        Node* n = _find_script_node(
            p_edited_scene,
            p_current_node->get_child(i),
            script
        );
        if (n) {
            return n;
...
void VisualScriptEditor::drop_data_fw(
    const Point2& p_point,
    const Variant& p_data,
    Control* p_from
) {
    ...
    if (String(d["type"]) == "visual_script_node_drag") {
        ...
        int new_id =
            _create_new_node_from_name(d["node_type"], pos, default_func);
        ...
        if (files.size()) {
            ...
            for (int i = 0; i < files.size(); i++) {
                ...
                if (drop_script.is_valid() && drop_script->is_tool()
                    && drop_script->get_instance_base_type()
    ...
    if (String(d["type"]) == "nodes") {
        ...
        if (!sn) {
            EditorNode::get_singleton()->show_warning(vformat(
                TTR("Can't drop nodes because script '%s' is not used in this "
                    "scene."),
                get_name()
            ));
            return;
        ...
        if (use_node || nodes.size() > 1) {
            ...
            new_connect_node_select
                ->select_from_instance(node, "", false, node->get_class());
        }
        undo_redo->add_do_method(this, "_update_graph");
        undo_redo->add_undo_method(this, "_update_graph");
        undo_redo->commit_action();
    ...
    if (String(d["type"]) == "obj_property") {
        ...
        if (!sn && !Input::get_singleton()->is_key_pressed(KEY_SHIFT)) {
            EditorNode::get_singleton()->show_warning(vformat(
                TTR("Can't drop properties because script '%s' is not used in "
                    "this scene.\nDrop holding 'Shift' to just copy the "
                    "signature."),
                get_name()
            ));
            return;
        ...
        if (!node || Input::get_singleton()->is_key_pressed(KEY_SHIFT)) {
            ...
            undo_redo
                ->add_do_method(vnode.ptr(), "set_property", d["property"]);
            if (!use_get) {
                undo_redo->add_do_method(
                    vnode.ptr(),
            ...
            if (!use_get) {
                ...
                if (sn == node) {
                    ...
                    pset->set_call_mode(
                        VisualScriptPropertySet::CALL_MODE_NODE_PATH
                    );
                ...
                if (sn == node) {
                    ...
                    pget->set_call_mode(
                        VisualScriptPropertyGet::CALL_MODE_NODE_PATH
                    );
...
void VisualScriptEditor::_selected_method(
    const String& p_method,
    const String& p_type,
    const bool p_connecting
) {
    Ref<VisualScriptFunctionCall> vsfc =
        script->get_node(default_func, selecting_method_id);
    if (!vsfc.is_valid()) {
        return;
    }
...
void VisualScriptEditor::set_edited_resource(const RES& p_res) {
    ...
    if (!script->has_function(default_func
        )) // this is the supposed default function
    {
...
String VisualScriptEditor::get_name() {
    ...
    if (script->get_path().find("local://") == -1
        && script->get_path().find("::") == -1) {
        ...
        name =
            script->get_class() + "(" + itos(script->get_instance_id()) + ")";
    }
...
void VisualScriptEditor::_center_on_node(const StringName& p_func, int p_id) {
    ...
    if (gn) {
        ...
        Vector2 new_scroll = gn->get_offset() * graph->get_zoom()
    ...
    for (List<StringName>::Element* E = functions.front(); E; E = E->next()) {
        if (script->has_node(E->get(), p_line)) {
            ...
            call_deferred(
                ...
                E->get(),
                p_line
            ); // editor might be just created and size might not exist yet
            return;
        }
    }
}
    ...
    for (List<StringName>::Element* E = functions.front(); E; E = E->next()) {
        ...
        for (List<int>::Element* F = nodes.front(); F; F = F->next()) {
            ...
            if (vsn->is_breakpoint()) {
                p_breakpoints->push_back(
                    F->get() - 1
                ); // subtract 1 because breakpoints in text start from zero
            }
        }
    }
}

void VisualScriptEditor::add_callback(
    const String& p_function,
    PoolStringArray p_args
) {
...
void VisualScriptEditor::_node_selected(Node* p_node) {
    ...
    EditorNode::get_singleton()->push_item(vnode.ptr()
    ); // edit node in inspector
}

static bool _get_out_slot(
    const Ref<VisualScriptNode>& p_node,
    int p_slot,
    int& r_real_slot,
    bool& r_sequence
) {
...
void VisualScriptEditor::_move_node(
...
void VisualScriptEditor::_remove_node(int p_id) {
    ...
    undo_redo->add_undo_method(
        ...
        func,
        p_id,
        script->get_node(func, p_id),
        script->get_node_position(func, p_id)
    );
    ...
    for (List<VisualScript::DataConnection>::Element* E = data_conns.front(); E;
         E                                              = E->next()) {
        if (E->get().from_node == p_id || E->get().to_node == p_id) {
            undo_redo->add_undo_method(
                script.ptr(),
...
bool VisualScriptEditor::node_has_sequence_connections(
    const StringName& p_func,
    int p_id
) {
    List<VisualScript::SequenceConnection> sequence_conns;
...
void VisualScriptEditor::_graph_connected(
    const String& p_from,
    int p_from_slot,
    const String& p_to,
    int p_to_slot
    ...
    Ref<VisualScriptNode> from_node =
        script->get_node(from_func, p_from.to_int());
    ...
    if (from_seq) {
        if (script->has_sequence_connection(
                from_func,
                p_from.to_int(),
                from_port,
                p_to.to_int()
    ...
    } else if (script->has_data_connection(
                   from_func,
                   p_from.to_int(),
                   from_port,
                   p_to.to_int(),
    ...
    StringName func; // this the func where we store the one the nodes at the
                     // end of the resolution on having multiple nodes
    ...
    if (from_func == to_func) {
        ...
        _move_nodes_with_rescan(
            to_func,
            from_func,
            p_to.to_int()
        ); // this function moves the nodes from func1 to func2
        func = from_func;
    } else {
        if (node_has_sequence_connections(to_func, p_to.to_int())) {
            if (node_has_sequence_connections(from_func, p_from.to_int())) {
                ERR_PRINT(
                    "Trying to connect between different sequence node trees"
                );
                return;
            } else {
    ...
    if (from_seq) {
        ...
        if (oper.is_valid() && oper->get_typed() == Variant::NIL) {
            ...
            if (from_node->get_output_value_port_info(from_port).type
                != Variant::NIL) {
                oper->set_typed(
                    from_node->get_output_value_port_info(from_port).type
                );
            }
        }
        ...
        if (operf.is_valid() && operf->get_typed() == Variant::NIL) {
            // it's an operator Node and if the type is already nil
            if (to_node->get_input_value_port_info(to_port).type
                != Variant::NIL) {
                operf->set_typed(
                    to_node->get_input_value_port_info(to_port).type
                );
            }
        }

        Variant::Type to_type =
            to_node->get_input_value_port_info(to_port).type;
        Variant::Type from_type =
            from_node->get_output_value_port_info(from_port).type;

        if (to_type != Variant::NIL && from_type != Variant::NIL
            && to_type != from_type) {
            // add a constructor node between the ports
            bool exceptions = false; // true if there are any exceptions
            exceptions =
                exceptions
                || (to_type == Variant::INT && from_type == Variant::REAL);
            exceptions =
                exceptions
                || (to_type == Variant::REAL && from_type == Variant::INT);
            if (Variant::can_convert(from_type, to_type) && !exceptions) {
                ...
                GraphNode* gn =
                    Object::cast_to<GraphNode>(graph->get_node(p_from));
                GraphNode* gn2 =
                    Object::cast_to<GraphNode>(graph->get_node(p_to));
                if (gn && gn2) {
                    Vector2 from_node_size = gn->get_rect().get_size();
                    Vector2 to_node_size   = gn2->get_rect().get_size();
                    Vector2 to_node_pos =
                        script->get_node_position(func, p_to.to_int());
                    Vector2 from_node_pos =
                        script->get_node_position(func, p_from.to_int());
                    Vector2 new_to_node_pos = from_node_pos;
                    Vector2 constructor_pos;
                    if ((to_node_pos.x - from_node_pos.x) < 0) {
                        // to is behind from node
                        if (to_node_pos.x
                            > (from_node_pos.x - to_node_size.x - 240)) {
                            new_to_node_pos.x =
                                from_node_pos.x - to_node_size.x
                                - 240; // approx size of constructor node +
                                       // padding
                        } else {
                        ...
                        if (to_node_pos.x
                            < (from_node_size.x + from_node_pos.x + 240)) {
                            new_to_node_pos.x =
                                from_node_size.x + from_node_pos.x
                                + 240; // approx size of constructor node +
                                       // padding
                        } else {
                            new_to_node_pos.x = to_node_pos.x;
                        ...
                        new_to_node_pos.y = to_node_pos.y;
                        constructor_pos.x =
                            from_node_size.x + from_node_pos.x + 10;
                        constructor_pos.y = to_node_pos.y;
                    }
                    undo_redo->add_do_method(
                        this,
                    ...
                    undo_redo->add_do_method(
                        ...
                        conv_node,
                        constructor,
                        _get_available_pos(false, constructor_pos)
                    );
                    undo_redo->add_undo_method(
                        script.ptr(),
                        "remove_node",
        ...
        if (script
                ->is_input_value_port_connected(func, p_to.to_int(), to_port)) {
        ...
        if (!converted) {
            ...
            // I don't think this is needed but gonna leave it here for now...
            // until I need to finalise it all
            undo_redo->add_undo_method(
                script.ptr(),
                "data_disconnect",
                func,
...
void VisualScriptEditor::_graph_disconnected(
    const String& p_from,
    int p_from_slot,
    const String& p_to,
    int p_to_slot
...
void VisualScriptEditor::_move_nodes_with_rescan(
    const StringName& p_func_from,
    const StringName& p_func_to,
    int p_id
) {
    Set<int> nodes_to_move;
    HashMap<int, Map<int, int>> seqconns_to_move; // from => List(outp, to)
    HashMap<int, Map<int, Pair<int, int>>>
        dataconns_to_move; // to => List(inp_p => from, outp)
...

    {
                ...
                for (auto E = connections[id].front(); E; E = E->next()) {
                    if (seen.has(id) && seen[id].has(E->key())) {
                        if (!E->next()) {
                            ...
                            id = -11; // I assume ids can't be negative should
                                      // confirm it...
                            break;
                        }
                        continue;
                    ...
                    dataconns_to_move[id].insert(
                        E->key(),
                        Pair<int, int>(E->get().first, E->get().second)
                    );
                    id = E->get().first;
        ...
        for (Set<int>::Element* E = nodes_to_be_added.front(); E;
             E                    = E->next()) {
    ...
    for (Set<int>::Element* E = nodes_to_move.front(); E; E = E->next()) {
        ...
        undo_redo->add_do_method(
            ...
            p_func_to,
            id,
            script->get_node(p_func_from, id),
            script->get_node_position(p_func_from, id)
        );
    ...
    for (List<int>::Element* E = skeys.front(); E; E = E->next()) {
        int from_node = E->get();
        for (Map<int, int>::Element* F = seqconns_to_move[from_node].front(); F;
             F                         = F->next()) {
            int from_port = F->key();
            int to_node   = F->get();
            undo_redo->add_do_method(
    ...
    for (List<int>::Element* E = keys.front(); E; E = E->next()) {
        ...
        for (Map<int, Pair<int, int>>::Element* F =
                 dataconns_to_move[E->get()].front();
             F;
             F = F->next()) {
            int inp_p          = F->key();
    ...
    for (List<VisualScript::SequenceConnection>::Element* E = seqext.front(); E;
         E                                                  = E->next()) {
        undo_redo->add_undo_method(
            script.ptr(),
            "sequence_connect",
    ...
    for (List<VisualScript::DataConnection>::Element* E = dataext.front(); E;
         E                                              = E->next()) {
        undo_redo->add_undo_method(
            script.ptr(),
            "data_connect",
    ...
    // this doesn't need do methods as they are handled by the subsequent do
    // calls implicitly
...
void VisualScriptEditor::_graph_connect_to_empty(
    const String& p_from,
    int p_from_slot,
    ...
    if (p_from_slot < vsn->get_output_sequence_port_count()) {
        ...
        port_action_output =
            p_from_slot - vsn->get_output_sequence_port_count();
        port_action_node = p_from.to_int();
        _port_action_menu(CREATE_CALL_SET_GET, func);
    }
}

VisualScriptNode::TypeGuess VisualScriptEditor::_guess_output_type(
    int p_port_action_node,
...
void VisualScriptEditor::_port_action_menu(
    int p_option,
    const StringName& func
) {
    Set<int> vn;
    ...
    switch (p_option) {
        case CREATE_CALL_SET_GET: {
            ...
            String type_string;
            if (script->get_node(func, port_action_node)
                    ->get_output_value_port_count()
                > 0) {
                type_string =
...
void VisualScriptEditor::connect_data(
    ...
    if (vnode_return != nullptr
        && vnode_old->get_output_value_port_count() > 0) {
...
void VisualScriptEditor::_selected_connect_node(
    const String& p_text,
    ...
    if (p_category == "visualscript") {
        ...
        if (Object::cast_to<VisualScriptTypeCast>(vnode_new.ptr())
            ...
            Variant::Type type =
                vnode_old->get_output_value_port_info(port_action_output).type;
            String hint_name =
                vnode_old->get_output_value_port_info(port_action_output)
                    .hint_string;

            if (type == Variant::OBJECT) {
                Object::cast_to<VisualScriptTypeCast>(vnode_new.ptr())
                    ->set_base_type(hint_name);
            } else if (type == Variant::NIL) {
                Object::cast_to<VisualScriptTypeCast>(vnode_new.ptr())
                    ->set_base_type("");
            } else {
                Object::cast_to<VisualScriptTypeCast>(vnode_new.ptr())
                    ->set_base_type(Variant::get_type_name(type));
            }
        }
    ...
    undo_redo->create_action(TTR("Add Node"));
    undo_redo
        ->add_do_method(script.ptr(), "add_node", func, new_id, vnode, pos);
    undo_redo->add_undo_method(script.ptr(), "remove_node", func, new_id);
    ...
    if (Object::cast_to<VisualScriptFunctionCall>(vsn.ptr())) {
        ...
        if (port_node_exists && p_connecting) {
            ...
            if (tg.type == Variant::OBJECT) {
                ...
                vsfc->set_call_mode(
                    VisualScriptFunctionCall::CALL_MODE_BASIC_TYPE
                );
...
void VisualScriptEditor::connect_seq(
    Ref<VisualScriptNode> vnode_old,
    Ref<VisualScriptNode> vnode_new,
    int new_id
) {
    ...
    if (vnode_operator != nullptr
        && !vnode_operator->has_input_sequence_port()) {
        return;
    }
    ...
    if (vnode_old->get_output_value_port_info(port_action_output).name
            == String("pass")
        && !script->get_output_sequence_ports_connected(func, port_action_node)
                .has(pass_port)) {
        undo_redo->add_do_method(
            script.ptr(),
            "sequence_connect",
...
void VisualScriptEditor::_selected_new_virtual_method(
    const String& p_text,
    const String& p_category,
    const bool p_connecting
) {
    ...
    for (int i = 0; i < minfo.arguments.size(); i++) {
        func_node->add_argument(
            minfo.arguments[i].type,
            minfo.arguments[i].name,
            -1,
            minfo.arguments[i].hint,
...
int VisualScriptEditor::_create_new_node_from_name(
    const String& p_text,
    ...
    undo_redo->create_action(TTR("Add Node"));
    undo_redo
        ->add_do_method(script.ptr(), "add_node", func, new_id, vnode, p_point);
    undo_redo->add_undo_method(script.ptr(), "remove_node", func, new_id);
    undo_redo->add_do_method(this, "_update_graph");
    undo_redo->add_undo_method(this, "_update_graph");
    undo_redo->commit_action();
...
void VisualScriptEditor::_default_value_changed() {
    Ref<VisualScriptNode> vsn =
        script->get_node(_get_function_of_node(editing_id), editing_id);
    if (vsn.is_null()) {
        return;
    }
    ...
    undo_redo->add_do_method(
        ...
        "set_default_input_value",
        editing_input,
        default_value_edit->get_variant()
    );
    undo_redo->add_undo_method(
        vsn.ptr(),
        "set_default_input_value",
...
void VisualScriptEditor::_default_value_edited(
    Node* p_button,
    int p_id,
    int p_input_port
) {
    Ref<VisualScriptNode> vsn =
        script->get_node(_get_function_of_node(p_id), p_id);
    if (vsn.is_null()) {
        return;
    }
    ...
    default_value_edit->set_position(
        Object::cast_to<Control>(p_button)->get_global_position()
        + Vector2(0, Object::cast_to<Control>(p_button)->get_size().y)
    );
    default_value_edit->set_size(Size2(1, 1));

    if (pinfo.type == Variant::NODE_PATH) {
        Node* edited_scene = get_tree()->get_edited_scene_root();
        if (edited_scene) { // Fixing an old crash bug ( Visual Script Crashes
                            // on editing NodePath with an empty scene open)
            Node* script_node =
                _find_script_node(edited_scene, edited_scene, script);
...
void VisualScriptEditor::_notification(int p_what) {
    switch (p_what) {
        ...
        case NOTIFICATION_THEME_CHANGED: {
            ...
            edit_variable_edit->add_style_override(
                "bg",
                get_stylebox("bg", "Tree")
            );
            edit_signal_edit->add_style_override(
                "bg",
                get_stylebox("bg", "Tree")
            );
            func_input_scroll->add_style_override(
                "bg",
                get_stylebox("bg", "Tree")
            );

            Ref<Theme> tm =
                EditorNode::get_singleton()->get_theme_base()->get_theme();

            bool dark_theme = tm->get_constant("dark_theme", "Editor");

            List<Pair<String, Color>> colors;
            if (dark_theme) {
                colors.push_back(Pair<String, Color>(
                    "flow_control",
                    Color(0.96f, 0.96f, 0.96f)
                ));
                colors.push_back(
                    Pair<String, Color>("functions", Color(0.96f, 0.52f, 0.51f))
                );
                colors.push_back(
                    Pair<String, Color>("data", Color(0.5f, 0.96f, 0.81f))
                );
                colors.push_back(
                    Pair<String, Color>("operators", Color(0.67f, 0.59f, 0.87f))
                );
                colors.push_back(
                    Pair<String, Color>("custom", Color(0.5f, 0.73f, 0.96f))
                );
                colors.push_back(
                    Pair<String, Color>("constants", Color(0.96f, 0.5f, 0.69f))
                );
            } else {
                colors.push_back(Pair<String, Color>(
                    "flow_control",
                    Color(0.26f, 0.26f, 0.26f)
                ));
                colors.push_back(
                    Pair<String, Color>("functions", Color(0.95f, 0.4f, 0.38f))
                );
                colors.push_back(
                    Pair<String, Color>("data", Color(0.07f, 0.73f, 0.51f))
                );
                colors.push_back(
                    Pair<String, Color>("operators", Color(0.51f, 0.4f, 0.82f))
                );
                colors.push_back(
                    Pair<String, Color>("custom", Color(0.31f, 0.63f, 0.95f))
                );
                colors.push_back(
                    Pair<String, Color>("constants", Color(0.94f, 0.18f, 0.49f))
                );
            }

            for (List<Pair<String, Color>>::Element* E = colors.front(); E;
                 E                                     = E->next()) {
...
void VisualScriptEditor::_graph_ofs_changed(const Vector2& p_ofs) {
    ...
    // Just use the default func for all the properties that need to be handled
    // for drawing rather than adding to the Visual Script Class
    if (script->has_function(default_func)) {
        script->set_function_scroll(
            default_func,
            graph->get_scroll_ofs() / EDSCALE
        );
        script->set_edited(true);
    }
    updating_graph = false;
...
void VisualScriptEditor::_comment_node_resized(
    ...
    if (graph->is_using_snap()) {
        ...
        Vector2 min_size =
            (gn->get_minimum_size() + (snap * 0.5)).snapped(snap);
...
void VisualScriptEditor::_menu_option(int p_what) {
    switch (p_what) {
        ...
        case EDIT_TOGGLE_BREAKPOINT: {
            ...
            for (List<String>::Element* E = reselect.front(); E;
                 E                        = E->next()) {
                GraphNode* gn =
                    Object::cast_to<GraphNode>(graph->get_node(E->get()));
                gn->set_selected(true);
            }
        ...
        case EDIT_CREATE_FUNCTION: {
                    ...
                    if (gn->is_selected()) {
                        ...
                        if (Object::cast_to<VisualScriptFunction>(*node)) {
                            EditorNode::get_singleton()->show_warning(TTR(
                                "Can't create function with a function node."
                            ));
                            return;
                        }
                        if (node.is_valid()) {
                            if (func != function
                                && function != StringName("")) {
                                EditorNode::get_singleton()->show_warning(
                                    TTR("Can't create function of nodes from "
                                        "nodes of multiple functions.")
                                );
                                return;
                            }
            ...
            if (nodes.size() == 0) {
                return; // nothing to be done if there are no valid nodes
                        // selected
            }
            ...
            Set<int> end_nodes;
            if (nodes.size() == 1) {
                Ref<VisualScriptNode> nd =
                    script->get_node(function, nodes.front()->key());
                ...
                if (seqs.size() == 0) {
                    ...
                    int top_nd = -1;
                    Vector2 top;
                    for (Map<int, Ref<VisualScriptNode>>::Element* E =
                             nodes.front();
                         E;
                         E = E->next()) {
                        Ref<VisualScriptNode> nd =
                            script->get_node(function, E->key());
                        if (nd.is_valid() && nd->has_input_sequence_port()) {
                            if (top_nd < 0) {
                                top_nd = E->key();
                                top =
                                    script->get_node_position(function, top_nd);
                            }
                            Vector2 pos =
                                script->get_node_position(function, E->key());
                            if (top.y > pos.y) {
                                top_nd = E->key();
                                top    = pos;
                            }
                    ...
                    Ref<VisualScriptNode> nd =
                        script->get_node(function, top_nd);
                    if (nd.is_valid() && nd->has_input_sequence_port()) {
                        start_node = top_nd;
                    } else {
                        EditorNode::get_singleton()->show_warning(
                    ...
                    for (List<VisualScript::SequenceConnection>::Element* E =
                        ...
                        if (nodes.has(E->get().from_node)
                            ...
                            if (start_node == -1) {
                                ...
                                EditorNode::get_singleton()->show_warning(
                                    TTR("Try to only have one sequence input "
                                        "in selection.")
                                );
                                return;
                            }
                    ...
                    if (start_node == -1) {
                        ...
                        // ie node without any input sequence but output
                        // sequence
                        for (Set<int>::Element* E = nodes_from.front(); E;
                             E                    = E->next()) {
            ...
            if (start_node == -1) {
                return; // this should not happen, but just in case something
                        // goes wrong
            }
                ...
                for (List<VisualScript::DataConnection>::Element* E =
                    ...
                    if (nodes.has(E->get().from_node)
                        ...
                        if (node.is_valid()) {
                            ...
                            PropertyInfo pi =
                                node->get_input_value_port_info(E->get().to_port
                                );
                            inputs.push_back(pi.type);
                            input_connections.push_back(Pair<int, int>(
                                E->get().to_node,
                                E->get().to_port
                            ));
                        }
            ...
            Vector2 pos = _get_available_pos(
                false,
                script->get_node_position(function, start_node)
                    - Vector2(80, 150)
            );
            ...
            for (Map<int, Ref<VisualScriptNode>>::Element* E = nodes.front(); E;
                 E                                           = E->next()) {
                undo_redo->add_do_method(
                    script.ptr(),
                    "remove_node",
                ...
                // undo_redo->add_undo_method(script.ptr(), "remove_node",
                // new_fn, E->key()); not needed cause we already remove the
                // function :P
                undo_redo->add_undo_method(
                    script.ptr(),
                    "add_node",
            ...
            // Add undo for external connections as well so that it's easier to
            // revert back and forth these didn't require do methods as it's
            // already handled internally by other do calls
            for (Set<VisualScript::SequenceConnection>::Element* E =
                     seqext.front();
                 E;
                 E = E->next()) {
            ...
            // I don't really think we need support for non sequenced functions
            // at this moment
            undo_redo->add_do_method(
                script.ptr(),
                "sequence_connect",
            ...
            // end nodes are mapped to the return nodes with data connections if
            // possible
            int m = 1;
            for (Set<int>::Element* G = end_nodes.front(); G; G = G->next()) {
                ...
                Vector2 posi = _get_available_pos(
                    false,
                    script->get_node_position(function, G->get())
                        + Vector2(80, -100)
                );
                undo_redo->add_do_method(
                    script.ptr(),
                ...
                Ref<VisualScriptNode> vsn =
                    script->get_node(function, G->get());
                if (vsn.is_valid() && vsn->get_output_value_port_count() > 0) {
                    ret_node->set_enable_return_value(true);
                    // use the zeroth data port cause that's the likely one that
                    // is planned to be used
                    ret_node->set_return_type(
                        vsn->get_output_value_port_info(0).type
                    );
                    undo_redo->add_do_method(
                        script.ptr(),
                        "data_connect",
            ...
            // * might make the system more intelligent by checking port from
            // info.
            int i                            = 0;
            ...
            for (List<Variant::Type>::Element* E = inputs.front(); E && F;
                 E = E->next(), F = F->next()) {
                func_node
                    ->add_argument(E->get(), "arg_" + String::num_int64(i), i);
                undo_redo->add_do_method(
                    script.ptr(),
                    "data_connect",
                    new_fn,
            ...
            // make sure all Nodes get marked for selection so that they can be
            // moved together
...
void VisualScriptEditor::_get_ends(
    ...
    const Set<int>& p_selected,
    Set<int>& r_end_nodes
) {
    for (const List<VisualScript::SequenceConnection>::Element* E =
             p_seqs.front();
         E;
         E = E->next()) {
        int from = E->get().from_node;
...
void VisualScriptEditor::_member_rmb_selected(const Vector2& p_pos) {
    ...
    if (ti->get_parent() == root->get_children()) {
        ...
        member_popup->add_icon_shortcut(
            edit_icon,
            ED_GET_SHORTCUT("visual_script_editor/edit_member"),
            MEMBER_EDIT
        );
        member_popup->add_separator();
        member_popup->add_icon_shortcut(
            del_icon,
            ED_GET_SHORTCUT("visual_script_editor/delete_selected"),
            MEMBER_REMOVE
        );
        member_popup->popup();
        return;
            ...
            if (p_option == MEMBER_REMOVE) {
                ...
                for (List<int>::Element* E = nodes.front(); E; E = E->next()) {
                    undo_redo->add_undo_method(
                        ...
                        name,
                        E->get(),
                        script->get_node(name, E->get()),
                        script->get_node_position(name, E->get())
                    );
                }
        ...
        case MEMBER_VARIABLE: {
            ...
            if (p_option == MEMBER_REMOVE) {
                ...
                undo_redo->add_undo_method(
                    ...
                    "set_variable_info",
                    name,
                    script->call("get_variable_info", name)
                ); // return as dict
                undo_redo->add_do_method(this, "_update_members");
                undo_redo->add_undo_method(this, "_update_members");
                undo_redo->commit_action();
                ...
                edit_variable_dialog->set_title(
                    TTR("Editing Variable:") + " " + name
                );
                edit_variable_dialog->popup_centered_minsize(
                    Size2(400, 200) * EDSCALE
                );
            }
        } break;
        case MEMBER_SIGNAL: {
            ...
            if (p_option == MEMBER_REMOVE) {
                ...
                undo_redo
                    ->add_do_method(script.ptr(), "remove_custom_signal", name);
                undo_redo
                    ->add_undo_method(script.ptr(), "add_custom_signal", name);

                for (int i = 0;
                     i < script->custom_signal_get_argument_count(name);
                     i++) {
                    undo_redo->add_undo_method(
                        script.ptr(),
                        "custom_signal_add_argument",
                ...
                edit_signal_dialog->set_title(
                    TTR("Editing Signal:") + " " + name
                );
                edit_signal_dialog->popup_centered_minsize(
                    Size2(400, 300) * EDSCALE
                );
            }
        } break;
    }
...
void VisualScriptEditor::_bind_methods() {
    ...
    ClassDB::bind_method(
        "_member_selected",
        &VisualScriptEditor::_member_selected
    );
    ClassDB::bind_method(
        "_update_members",
    ...
    ClassDB::bind_method(
        "_members_gui_input",
        &VisualScriptEditor::_members_gui_input
    );
    ClassDB::bind_method(
        "_member_rmb_selected",
        &VisualScriptEditor::_member_rmb_selected
    );
    ClassDB::bind_method("_member_option", &VisualScriptEditor::_member_option);
    ClassDB::bind_method(
        "_fn_name_box_input",
        &VisualScriptEditor::_fn_name_box_input
    );

    ClassDB::bind_method(
        "_change_base_type",
        &VisualScriptEditor::_change_base_type
    );
    ClassDB::bind_method(
        "_change_base_type_callback",
        &VisualScriptEditor::_change_base_type_callback
    );
    ClassDB::bind_method(
        "_toggle_tool_script",
        &VisualScriptEditor::_toggle_tool_script
    );
    ...
    ClassDB::bind_method(
        "_begin_node_move",
        &VisualScriptEditor::_begin_node_move
    );
    ...
    ClassDB::bind_method(
        "_update_graph",
        &VisualScriptEditor::_update_graph,
        DEFVAL(-1)
    );
    ClassDB::bind_method(
        "_node_ports_changed",
        &VisualScriptEditor::_node_ports_changed
    );

    ClassDB::bind_method(
        "_create_function_dialog",
        &VisualScriptEditor::_create_function_dialog
    );
    ClassDB::bind_method(
        "_create_function",
        &VisualScriptEditor::_create_function
    );
    ClassDB::bind_method(
        "_add_node_dialog",
        &VisualScriptEditor::_add_node_dialog
    );
    ClassDB::bind_method(
        "_add_func_input",
        &VisualScriptEditor::_add_func_input
    );
    ClassDB::bind_method(
        "_remove_func_input",
        &VisualScriptEditor::_remove_func_input
    );
    ClassDB::bind_method(
        "_deselect_input_names",
        &VisualScriptEditor::_deselect_input_names
    );

    ClassDB::bind_method(
        "_default_value_edited",
        &VisualScriptEditor::_default_value_edited
    );
    ClassDB::bind_method(
        "_default_value_changed",
        &VisualScriptEditor::_default_value_changed
    );
    ClassDB::bind_method("_menu_option", &VisualScriptEditor::_menu_option);
    ClassDB::bind_method(
        "_graph_ofs_changed",
        &VisualScriptEditor::_graph_ofs_changed
    );
    ClassDB::bind_method(
        "_center_on_node",
        &VisualScriptEditor::_center_on_node
    );
    ClassDB::bind_method(
        "_comment_node_resized",
        &VisualScriptEditor::_comment_node_resized
    );
    ClassDB::bind_method(
        "_button_resource_previewed",
    ...
    ClassDB::bind_method(
        "_selected_connect_node",
        &VisualScriptEditor::_selected_connect_node
    );
    ClassDB::bind_method(
        "_selected_new_virtual_method",
        &VisualScriptEditor::_selected_new_virtual_method
    );

    ClassDB::bind_method(
        "_cancel_connect_node",
        &VisualScriptEditor::_cancel_connect_node
    );
    ClassDB::bind_method(
        "_create_new_node_from_name",
        &VisualScriptEditor::_create_new_node_from_name
    );
    ClassDB::bind_method(
        "_expression_text_changed",
        &VisualScriptEditor::_expression_text_changed
    );
    ClassDB::bind_method(
        "_add_input_port",
        &VisualScriptEditor::_add_input_port
    );
    ClassDB::bind_method(
        "_add_output_port",
        &VisualScriptEditor::_add_output_port
    );
    ClassDB::bind_method(
        "_remove_input_port",
        &VisualScriptEditor::_remove_input_port
    );
    ClassDB::bind_method(
        "_remove_output_port",
        &VisualScriptEditor::_remove_output_port
    );
    ClassDB::bind_method(
        "_change_port_type",
        &VisualScriptEditor::_change_port_type
    );
    ClassDB::bind_method(
        "_update_node_size",
        &VisualScriptEditor::_update_node_size
    );
    ClassDB::bind_method(
        "_port_name_focus_out",
        &VisualScriptEditor::_port_name_focus_out
    );
    ...
    ClassDB::bind_method(
        "_graph_gui_input",
        &VisualScriptEditor::_graph_gui_input
    );

    ClassDB::bind_method("_on_nodes_copy", &VisualScriptEditor::_on_nodes_copy);
    ClassDB::bind_method(
        "_on_nodes_paste",
        &VisualScriptEditor::_on_nodes_paste
    );
    ClassDB::bind_method(
        "_on_nodes_delete",
        &VisualScriptEditor::_on_nodes_delete
    );
    ClassDB::bind_method(
        "_on_nodes_duplicate",
        &VisualScriptEditor::_on_nodes_duplicate
    );
    ...
    ClassDB::bind_method(
        "_graph_connected",
        &VisualScriptEditor::_graph_connected
    );
    ClassDB::bind_method(
        "_graph_disconnected",
        &VisualScriptEditor::_graph_disconnected
    );
    ClassDB::bind_method(
        "_graph_connect_to_empty",
        &VisualScriptEditor::_graph_connect_to_empty
    );
    ...
    ClassDB::bind_method(
        "_selected_method",
        &VisualScriptEditor::_selected_method
    );
    ClassDB::bind_method(
        "_draw_color_over_button",
        &VisualScriptEditor::_draw_color_over_button
    );

    ClassDB::bind_method(
        "_generic_search",
        &VisualScriptEditor::_generic_search
    );
}
...
VisualScriptEditor::VisualScriptEditor() {
    ...
    edit_menu->get_popup()->add_shortcut(
        ED_GET_SHORTCUT("visual_script_editor/copy_nodes"),
        EDIT_COPY_NODES
    );
    edit_menu->get_popup()->add_shortcut(
        ED_GET_SHORTCUT("visual_script_editor/cut_nodes"),
        EDIT_CUT_NODES
    );
    edit_menu->get_popup()->add_shortcut(
        ED_GET_SHORTCUT("visual_script_editor/paste_nodes"),
        EDIT_PASTE_NODES
    );
    edit_menu->get_popup()->add_separator();
    edit_menu->get_popup()->add_shortcut(
    ...
    edit_menu->get_popup()->add_shortcut(
        ED_GET_SHORTCUT("visual_script_editor/refresh_nodes"),
        REFRESH_GRAPH
    );
    ...
    function_create_dialog->get_ok()
        ->connect("pressed", this, "_create_function");
    ...
    default_value_edit
        ->connect("variant_changed", this, "_default_value_changed");
    ...
    new_connect_node_select
        ->connect("selected", this, "_selected_connect_node");
    new_connect_node_select->get_cancel()
        ->connect("pressed", this, "_cancel_connect_node");

    new_virtual_method_select = memnew(VisualScriptPropertySelector);
    add_child(new_virtual_method_select);
    new_virtual_method_select
        ->connect("selected", this, "_selected_new_virtual_method");
}
...
Ref<VisualScriptNode> _VisualScriptEditor::create_node_custom(
    const String& p_name
) {
...
void _VisualScriptEditor::add_custom_node(
    const String& p_name,
    const String& p_category,
    ...
    VisualScriptLanguage::singleton->add_register_func(
        node_name,
        &_VisualScriptEditor::create_node_custom
    );
    emit_signal("custom_nodes_updated");
}

void _VisualScriptEditor::remove_custom_node(
    const String& p_name,
    const String& p_category
) {
    String node_name = "custom/" + p_category + "/" + p_name;
...
void _VisualScriptEditor::_bind_methods() {
    ClassDB::bind_method(
        ...
        &_VisualScriptEditor::add_custom_node
    );
    ClassDB::bind_method(
        D_METHOD("remove_custom_node", "name", "category"),
        &_VisualScriptEditor::remove_custom_node
    );
