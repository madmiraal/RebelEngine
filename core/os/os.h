...
public:
    ...
    virtual void global_menu_add_item(
        const String& p_menu,
    ...
    void print_error(
        ...
        Logger::ErrorType p_type = Logger::ERR_ERROR
    );
    ...
    //
    // The maximum size of the area is Rect2(0, 0, window_size.width,
    // window_size.height).
    ...
    // returns height of the currently shown virtual keyboard (0 if keyboard is
    // hidden)
    ...
    ScreenOrientation get_screen_orientation_from_string(
    ...
    virtual Error dialog_input_text(
        String p_title,
        String p_description,
        String p_partial,
        Object* p_obj,
    ...
    // real, actual overridable function to switch vsync, which needs to be
    // called from graphics thread if needed
