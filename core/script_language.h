...
public:
    ...
    ) const = 0; // this may not work in all scripts, will return empty if so
...
public:
    ...
    virtual Error open_in_external_editor(
...
public:
    _FORCE_INLINE_ static ScriptDebugger* get_singleton() {
        return singleton;
    }
