...
class AnimationNode : public Resource {
    REBEL_OBJECT(AnimationNode, Resource);
...
public:
    ...
    float _pre_process(
        const StringName& p_base_path,
        AnimationNode* p_parent,
        State* p_state,
        float p_time,
        bool p_seek,
    ...
    float _blend_node(
        const StringName& p_subpath,
        const Vector<StringName>& p_connections,
        AnimationNode* p_new_parent,
...
class AnimationRootNode : public AnimationNode {
    REBEL_OBJECT(AnimationRootNode, AnimationNode);
...
class AnimationTree : public Node {
    REBEL_OBJECT(AnimationTree, Node);
...
private:
    ...
    void _update_properties_for_node(
...
public:
    ...
    float get_connection_activity(const StringName& p_path, int p_connection)
        const;
