...
public:
    enum TreeCellMode {
        ...
        CELL_MODE_CUSTOM, ///< Contains a custom value, show a string, and an
                          ///< edit button
    };
...
private:
    ...
    // void draw_item_text(String p_text,const Ref<Texture>& p_icon,int
    // p_icon_max_w,bool p_tool,Rect2i p_rect,const Color& p_color);
    void draw_item_rect(
...
public:
    ...
    // First item that starts with the text, from the current focused item down
    // and wraps around.
