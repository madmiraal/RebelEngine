...
class ResourceInteractiveLoaderText : public ResourceInteractiveLoader {
    ...
    static Error _parse_sub_resources(
        ...
        return reinterpret_cast<ResourceInteractiveLoaderText*>(p_self)
            ->_parse_sub_resource(p_stream, r_res, line, r_err_str);
    }
    ...
    static Error _parse_ext_resources(
        ...
        return reinterpret_cast<ResourceInteractiveLoaderText*>(p_self)
            ->_parse_ext_resource(p_stream, r_res, line, r_err_str);
    }

    Error _parse_sub_resource(
        VariantParser::Stream* p_stream,
        Ref<Resource>& r_res,
        int& line,
        String& r_err_str
    );
    Error _parse_ext_resource(
        VariantParser::Stream* p_stream,
        Ref<Resource>& r_res,
        int& line,
        String& r_err_str
    ...
    static Error _parse_sub_resource_dummys(
        void* p_self,
        VariantParser::Stream* p_stream,
        Ref<Resource>& r_res,
        int& line,
        ...
        return _parse_sub_resource_dummy(
            (DummyReadData*)(p_self),
            p_stream,
            r_res,
            line,
            r_err_str
    ...
    static Error _parse_ext_resource_dummys(
        void* p_self,
        VariantParser::Stream* p_stream,
        Ref<Resource>& r_res,
        int& line,
        ...
        return _parse_ext_resource_dummy(
            (DummyReadData*)(p_self),
            p_stream,
            r_res,
            line,
    ...
    static Error _parse_sub_resource_dummy(
    ...
    static Error _parse_ext_resource_dummy(
        DummyReadData* p_data,
        VariantParser::Stream* p_stream,
        Ref<Resource>& r_res,
        int& line,
...
public:
    ...
    static Error convert_file_to_binary(
...
class ResourceFormatSaverTextInstance {
    ...
    struct NonPersistentKey { // for resource properties generated on the fly
        ...
        bool operator<(const NonPersistentKey& p_key) const {
            return base == p_key.base ? property < p_key.property
                                      : base < p_key.base;
        }
    };
